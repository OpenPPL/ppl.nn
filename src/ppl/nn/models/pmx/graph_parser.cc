...
static const datatype_t g_type_fb2ppl[] = {
    DATATYPE_UNKNOWN,   DATATYPE_BOOL,       DATATYPE_INT8,    DATATYPE_UINT8,    DATATYPE_INT16,
    DATATYPE_UINT16,    DATATYPE_INT32,      DATATYPE_UINT32,  DATATYPE_INT64,    DATATYPE_UINT64,
    DATATYPE_FLOAT16,   DATATYPE_FLOAT32,    DATATYPE_FLOAT64, DATATYPE_BFLOAT16, DATATYPE_INT4B,
    DATATYPE_COMPLEX64, DATATYPE_COMPLEX128, DATATYPE_INT4X4,  DATATYPE_INT4X8,
};
