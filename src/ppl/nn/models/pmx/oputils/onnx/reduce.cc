...
Offset<ReduceParam> SerializeReduceParam(const ppl::nn::common::ReduceParam& param, FlatBufferBuilder* builder) {
...
void DeserializeReduceParam(const ReduceParam& fb_param, ppl::nn::common::ReduceParam* param) {
    param->type = static_cast<ppl::nn::common::ReduceParam::reduce_type_t>(fb_param.type());
