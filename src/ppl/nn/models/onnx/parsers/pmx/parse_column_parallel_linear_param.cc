...
RetCode ParseColumnParallelLinearParam(const ::onnx::NodeProto& pb_node, const onnx::ParamParserExtraArgs& args, ir::Node* node,
                                 ir::Attr* arg) {
    auto param = static_cast<ColumnParallelLinearParam*>(arg);
