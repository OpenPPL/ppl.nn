...
#include "parse_moe_reduce_param.h"
...
RetCode ParseMoeReduceParam(const ::onnx::NodeProto& pb_node, const onnx::ParamParserExtraArgs& args, ir::Node* node, ir::Attr* arg) {
