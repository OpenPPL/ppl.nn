...
#include "parse_moe_select_param.h"
...
RetCode ParseMoeSelectParam(const ::onnx::NodeProto& pb_node, const onnx::ParamParserExtraArgs& args, ir::Node* node, ir::Attr* arg) {

    auto param = static_cast<MoeSelectParam*>(arg);
