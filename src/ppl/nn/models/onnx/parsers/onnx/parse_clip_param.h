...
#ifndef _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_CLIP_PARAM_H_
...
ppl::common::RetCode ParseClipParam(const ::onnx::NodeProto& pb_node, const std::map<std::string, uint64_t>& op_sets,
