...
ppl::common::RetCode ParseIfParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackIfParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
