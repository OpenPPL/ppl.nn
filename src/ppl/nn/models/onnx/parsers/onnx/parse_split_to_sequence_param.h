...
ppl::common::RetCode ParseSplitToSequenceParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*,
                                               ir::Attr*);

ppl::common::RetCode PackSplitToSequenceParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
