...
ppl::common::RetCode ParseLSTMParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackLSTMParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
