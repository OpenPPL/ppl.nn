...
ppl::common::RetCode ParseSplitParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackSplitParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
