...
#ifndef _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_SCATTER_ELEMENTS_PARAM_H_
#define _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_SCATTER_ELEMENTS_PARAM_H_
...
ppl::common::RetCode PackScatterElementsParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
