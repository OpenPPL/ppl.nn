...
ppl::common::RetCode ParseSqueezeParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackSqueezeParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
