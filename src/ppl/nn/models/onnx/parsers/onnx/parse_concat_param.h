...
ppl::common::RetCode ParseConcatParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackConcatParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
