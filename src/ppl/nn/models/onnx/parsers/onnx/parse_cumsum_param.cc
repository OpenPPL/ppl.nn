...
ppl::common::RetCode ParseCumSumParam(const ::onnx::NodeProto& pb_node, const map<string, uint64_t>&, void* arg,
                                    ir::Node*, ir::GraphTopo*) {
    auto cumsum_param = static_cast<ppl::nn::common::CumSumParam*>(arg);
