...
ppl::common::RetCode ParsePoolingParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackPoolingParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
