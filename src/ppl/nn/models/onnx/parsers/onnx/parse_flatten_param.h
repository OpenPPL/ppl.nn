...
ppl::common::RetCode ParseFlattenParam(const ::onnx::NodeProto&, const ParamParserExtraArgs&, ir::Node*, ir::Attr*);

ppl::common::RetCode PackFlattenParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
