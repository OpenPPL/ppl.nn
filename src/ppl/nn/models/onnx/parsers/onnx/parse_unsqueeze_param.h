...
#ifndef _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_UNSQUEEZE_PARAM_H_
#define _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_UNSQUEEZE_PARAM_H_
...
ppl::common::RetCode PackUnsqueezeParam(const ir::Node*, const ir::Attr*, ::onnx::NodeProto*);
