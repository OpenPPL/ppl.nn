...
#ifndef _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_INSTANCENORMALIZATION_PARAM_H_
#define _ST_HPC_PPL_NN_MODELS_ONNX_PARSERS_PARSE_INSTANCENORMALIZATION_PARAM_H_
