...
ParamParserManager::ParamParserManager() {
    ...
    PPL_REGISTER_OP_WITH_PARAM("", "Clip", 6, 16, ClipParam, ParseClipParam, PackClipParam);
    ...
    PPL_REGISTER_OP_WITH_PARAM("", "Slice", 1, 16, SliceParam, ParseSliceParam, PackSliceParam);
