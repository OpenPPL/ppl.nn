...
#include "ppl/nn/engines/riscv/kernels/onnx/averagepool_kernel.h"
#include "ppl/nn/engines/riscv/utils/macros.h"
#include "ppl/nn/runtime/tensor_impl.h"

#include "ppl/kernel/riscv/fp16/averagepool2d.h"
#include "ppl/kernel/riscv/fp32/averagepool2d.h"
...
ppl::common::RetCode AveragePoolKernel::DoExecute(KernelExecContext* ctx) {
    ...
    if (data_format == ppl::common::DATAFORMAT_N8CX && data_type == ppl::common::DATATYPE_FLOAT16) {
        ...
        //     return ppl::kernel::riscv::averagepool2d_nchw_normal_fp16(
        //         &X->GetShape(),
        //         &Y->GetShape(),
        //         kernel_h, kernel_w,
        //         stride_h, stride_w,
