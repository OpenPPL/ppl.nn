...
#include "ppl/kernel/riscv/fp16/scatter_nd.h"
#include "ppl/kernel/riscv/fp32/scatter_nd.h"
...
ppl::common::RetCode ScatterNdKernel::DoExecute(KernelExecContext* ctx) {
    ...
    PPLNN_RISCV_REQUIRED_INPUT(updates, 2);
    ...
    PPLNN_RISCV_DEBUG_TRACE("Input [updates]:\n");
    PPL_RISCV_TENSOR_PRINT_DEBUG_MSG(updates);
