...
RetCode RiscvDevice::Convert(BufferDesc* dst, const TensorShape& dst_desc, const BufferDesc& src,
...
RetCode RiscvDevice::ConvertToHost(void* dst, const TensorShape& dst_desc, const BufferDesc& src,
                                   const TensorShape& src_desc, const void*) {
    BufferDesc dst_wrapper(dst);
    return Convert(&dst_wrapper, dst_desc, src, src_desc);
}

RetCode RiscvDevice::ConvertToHostAsync(void* dst, const TensorShape& dst_desc, const BufferDesc& src,
                                        const TensorShape& src_desc, const void* dst_info) {
    return ConvertToHost(dst, dst_desc, src, src_desc, dst_info);
}

RetCode RiscvDevice::ConvertFromHost(BufferDesc* dst, const TensorShape& dst_desc, const void* src,
                                     const TensorShape& src_desc, const void*) {
    return Convert(dst, dst_desc, BufferDesc(const_cast<void*>(src)), src_desc);
}

RetCode RiscvDevice::ConvertFromHostAsync(BufferDesc* dst, const TensorShape& dst_desc, const void* src,
