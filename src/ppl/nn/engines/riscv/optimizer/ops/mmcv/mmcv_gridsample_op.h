...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_MMCV_MMCV_GRIDSAMPLE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_MMCV_MMCV_GRIDSAMPLE_OP_H_
...
class MMCVGridSampleOp final : public RiscvOptKernel {
public:
    MMCVGridSampleOp(const ir::Node* node) : RiscvOptKernel(node) {}
