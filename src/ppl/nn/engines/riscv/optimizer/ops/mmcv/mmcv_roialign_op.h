...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_MMCV_MMCV_ROIALIGN_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_MMCV_MMCV_ROIALIGN_OP_H_
...
class MMCVROIAlignOp final : public RiscvOptKernel {
public:
    MMCVROIAlignOp(const ir::Node* node) : RiscvOptKernel(node) {}
...
private:
    std::shared_ptr<ppl::nn::mmcv::MMCVRoiAlignParam> param_;
};
