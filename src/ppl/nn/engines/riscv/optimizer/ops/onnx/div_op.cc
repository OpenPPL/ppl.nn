...
#include "ppl/nn/engines/riscv/kernels/onnx/div_kernel.h"
...
RetCode DivOp::SelectDataType(const InputOutputInfo& info, std::vector<datatype_t>* selected_input_data_types,
