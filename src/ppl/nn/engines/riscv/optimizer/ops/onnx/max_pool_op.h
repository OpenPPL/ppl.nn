...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_MAX_POOL_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_MAX_POOL_OP_H_
...
class MaxPoolOp final : public RISCVOptKernel {
public:
    MaxPoolOp(const ir::Node* node) : RISCVOptKernel(node) {}
