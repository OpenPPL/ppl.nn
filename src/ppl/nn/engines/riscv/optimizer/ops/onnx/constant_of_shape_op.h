...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_CONSTANT_OF_SHAPE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_CONSTANT_OF_SHAPE_OP_H_
...
class ConstantOfShapeOp final : public RiscvOptKernel {
public:
    ConstantOfShapeOp(const ir::Node* node) : RiscvOptKernel(node) {}
...
private:
    std::shared_ptr<ppl::nn::common::ConstantOfShapeParam> param_;
};
