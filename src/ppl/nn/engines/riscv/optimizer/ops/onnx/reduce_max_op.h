...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_REDUCE_MAX_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_REDUCE_MAX_OP_H_
...
class ReduceMaxOp final : public RiscvOptKernel {
public:
    ReduceMaxOp(const ir::Node* node) : RiscvOptKernel(node) {}
