...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_SPLIT_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_SPLIT_OP_H_
...
class SplitOp final : public RiscvOptKernel {
public:
    SplitOp(const ir::Node* node) : RiscvOptKernel(node) {}
