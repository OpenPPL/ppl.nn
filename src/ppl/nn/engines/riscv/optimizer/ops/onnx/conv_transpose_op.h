...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_CONV_TRANSPOSE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_CONV_TRANSPOSE_OP_H_
...
class ConvTransposeOp final : public RiscvOptKernel {
public:
    ConvTransposeOp(const ir::Node* node) : RiscvOptKernel(node) {}
