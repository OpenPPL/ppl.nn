...
RetCode SqrtOp::SelectFormat(const InputOutputInfo& info, vector<dataformat_t>* selected_input_formats,
...
RetCode SqrtOp::SelectDataType(const InputOutputInfo& info, datatype_t forward_precision,
