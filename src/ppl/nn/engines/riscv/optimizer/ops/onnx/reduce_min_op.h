...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_REDUCE_MIN_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_REDUCE_MIN_OP_H_
...
class ReduceMinOp final : public RISCVOptKernel {
public:
    ReduceMinOp(const ir::Node* node) : RISCVOptKernel(node) {}
