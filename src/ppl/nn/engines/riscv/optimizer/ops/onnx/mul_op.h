...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_MUL_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_MUL_OP_H_

#include "ppl/nn/engines/riscv/optimizer/opt_kernel.h"

namespace ppl { namespace nn { namespace riscv {

class MulOp final : public RiscvOptKernel {
public:
    MulOp(const ir::Node* node) : RiscvOptKernel(node) {}
