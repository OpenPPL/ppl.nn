...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_NON_MAX_SUPPRESSION_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_NON_MAX_SUPPRESSION_OP_H_
...
class NonMaxSupressionOp final : public RiscvOptKernel {
public:
    NonMaxSupressionOp(const ir::Node* node) : RiscvOptKernel(node) {}
...
private:
    std::shared_ptr<ppl::nn::common::NonMaxSuppressionParam> param_;
};
