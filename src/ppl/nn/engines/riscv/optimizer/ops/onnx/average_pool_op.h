...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_AVERAGE_POOL_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_AVERAGE_POOL_OP_H_
...
class AveragePoolOp final : public RISCVOptKernel {
public:
    AveragePoolOp(const ir::Node* node) : RISCVOptKernel(node) {}
