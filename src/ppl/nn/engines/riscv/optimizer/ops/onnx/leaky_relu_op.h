...
#ifndef _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_LEAKY_RELU_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_RISCV_OPTIMIZER_OPS_ONNX_LEAKY_RELU_OP_H_
...
class LeakyReLUOp final : public RiscvOptKernel {
public:
    LeakyReLUOp(const ir::Node* node) : RiscvOptKernel(node) {}
