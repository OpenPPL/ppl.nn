...
template <>
struct uint_type_helper<float> {typedef uint32_t U;};
template <>
struct uint_type_helper<__fp16> {typedef uint16_t U;};
template <>
struct uint_type_helper<int64_t> {typedef uint64_t U;};
...
template <>
struct register_v_helper<int64_t, 128> {typedef int64xm1_t U;};
template <>
struct register_v_helper<uint32_t, 128> {typedef uint32xm1_t U;};
template <>
struct register_v_helper<uint16_t, 128> {typedef uint16xm1_t U;};
template <>
struct register_v_helper<uint64_t, 128> {typedef uint64xm1_t U;};
...
template <>
struct register_ve_helper<float, 128> {typedef e32xm1_t U;};
template <>
struct register_ve_helper<__fp16, 128> {typedef e16xm1_t U;};
template <>
struct register_ve_helper<int64_t, 128> {typedef e64xm1_t U;};
