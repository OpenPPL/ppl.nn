...
public:
    ...
    conv2d_n8cx_dw_fp16_runtime_executor(const conv2d_common_param* conv_param, const __fp16* cvt_filter,
                                         const __fp16* bias)
...
public:
    ...
    conv2d_n8cx_dw_fp16_offline_manager(const conv2d_common_param& param, const conv2d_common_algo_info& algo_info,
