...
inline void wb_b2f3s1_cvt_filter_blk_kernel(const __fp16* filter,
...
uint64_t conv2d_n8cx_wg_b2f3_fp16_runtime_executor::cal_temp_buffer_size() {
    ...
    size_t temp_buffer_size = conv_wg_bxfxs1_get_temp_buffer_size_fp16<2, 3>(src_shape_->GetDim(2), // src_h,
...
ppl::common::RetCode conv2d_n8cx_wg_b2f3_fp16_offline_manager::gen_cvt_weights(const __fp16* filter,
    ...
    }
    {
        ...
        conv_wg_bxfxs1_cvt_filter_fp16<2, 3, wb_b2f3s1_cvt_filter_blk_kernel>(filter, // filter,
