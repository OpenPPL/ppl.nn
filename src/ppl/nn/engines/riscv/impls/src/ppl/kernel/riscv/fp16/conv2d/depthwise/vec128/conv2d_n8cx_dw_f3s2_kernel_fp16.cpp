...
void conv_dw_f3s2_h3w4_kernel_riscv_fp16(const __fp16* src, const __fp16* flt, const __fp16* bias, __fp16* dst,

                                         int64_t src_pad_w, int64_t dst_h, int64_t dst_w) {
    asm volatile(".equ           ATOM_H, %c[ATOM_H]      \n\t"
                 ".equ           ATOM_W, %c[ATOM_W]      \n\t"
                 ...
                 "nop                                    \n\t"
                 :
                 : [ATOM_H] "i"(atom_h), [ATOM_W] "i"(atom_w), [SRC] "r"(src), [FLT] "r"(flt), [DST] "r"(dst),
                   [BIAS] "r"(bias), [H_STRIDE] "r"(src_pad_w * 8 * 2), [DST_H] "r"(dst_h), [DST_W] "r"(dst_w)
                 : "memory", "t0", "t1", "t2", "t3", "t4", "t5", "t6", "s2", "s3", "s4", "s5", "s6", "s7", "s8", "s9",
                   "s10", "s11", "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13",
