...
#ifndef __ST_PPL_KERNEL_RISCV_INT64_REDUCE_REDUCE_NDARRAY_INT64_H_
#define __ST_PPL_KERNEL_RISCV_INT64_REDUCE_REDUCE_NDARRAY_INT64_H_
...
static void reduce_ndarray_lastdim_no_reduce_int64(
    ...
    for (; i < dim_len; i += C_BLK()) {
        vsev_int64xm1(dst + i,
                        reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i, vl), vlev_int64xm1(dst + i, vl)), vl);
    }
}
...
static void reduce_ndarray_lastdim_reduce_int64(
    ...
    int64xm1_t v_tmp0 = vmvvx_int64xm1(init_val, vl);
    int64xm1_t v_tmp1 = v_tmp0;
    int64xm1_t v_tmp2 = v_tmp0;
    int64xm1_t v_tmp3 = v_tmp0;
    int64xm1_t v_tmp4 = v_tmp0;
    int64xm1_t v_tmp5 = v_tmp0;
    int64xm1_t v_tmp6 = v_tmp0;
    int64xm1_t v_tmp7 = v_tmp0;
    int64xm1_t v_tmp8 = v_tmp0;
    int64xm1_t v_tmp9 = v_tmp0;
    int64xm1_t v_tmp10 = v_tmp0;
    int64xm1_t v_tmp11 = v_tmp0;
    int64xm1_t v_tmp12 = v_tmp0;
    int64xm1_t v_tmp13 = v_tmp0;
    int64xm1_t v_tmp14 = v_tmp0;
    int64xm1_t v_tmp15 = v_tmp0;

    int64xm1_t v_tmp16 = v_tmp0;
    ...
    int64_t i = 0;
    for (; i + unroll_len < dim_len; i += unroll_len) {
        v_tmp0 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 0 * C_BLK(), vl), v_tmp0);
        v_tmp1 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 1 * C_BLK(), vl), v_tmp1);
        v_tmp2 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 2 * C_BLK(), vl), v_tmp2);
        v_tmp3 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 3 * C_BLK(), vl), v_tmp3);
        v_tmp4 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 4 * C_BLK(), vl), v_tmp4);
        v_tmp5 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 5 * C_BLK(), vl), v_tmp5);
        v_tmp6 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 6 * C_BLK(), vl), v_tmp6);
        v_tmp7 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 7 * C_BLK(), vl), v_tmp7);
        v_tmp8 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 8 * C_BLK(), vl), v_tmp8);
        v_tmp9 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 9 * C_BLK(), vl), v_tmp9);
        v_tmp10 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 10 * C_BLK(), vl), v_tmp10);
        v_tmp11 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 11 * C_BLK(), vl), v_tmp11);
        v_tmp12 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 12 * C_BLK(), vl), v_tmp12);
        v_tmp13 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 13 * C_BLK(), vl), v_tmp13);
        v_tmp14 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 14 * C_BLK(), vl), v_tmp14);
        v_tmp15 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i + 15 * C_BLK(), vl), v_tmp15);
    }
    for (; i < dim_len; i += C_BLK()) {
        v_tmp16 = reduce_vector_kernel_int64<op>(vlev_int64xm1(src + i, vl), v_tmp16);
    }

    if (dim_len >= unroll_len) {
        v_tmp0 = reduce_vector_kernel_int64<op>(v_tmp0, v_tmp1);
        v_tmp2 = reduce_vector_kernel_int64<op>(v_tmp2, v_tmp3);
        v_tmp4 = reduce_vector_kernel_int64<op>(v_tmp4, v_tmp5);
        v_tmp6 = reduce_vector_kernel_int64<op>(v_tmp6, v_tmp7);
        v_tmp8 = reduce_vector_kernel_int64<op>(v_tmp8, v_tmp9);
        v_tmp10 = reduce_vector_kernel_int64<op>(v_tmp10, v_tmp11);
        v_tmp12 = reduce_vector_kernel_int64<op>(v_tmp12, v_tmp13);
        v_tmp14 = reduce_vector_kernel_int64<op>(v_tmp14, v_tmp15);

        v_tmp0 = reduce_vector_kernel_int64<op>(v_tmp0, v_tmp2);
        v_tmp4 = reduce_vector_kernel_int64<op>(v_tmp4, v_tmp6);
        v_tmp8 = reduce_vector_kernel_int64<op>(v_tmp8, v_tmp10);
        v_tmp12 = reduce_vector_kernel_int64<op>(v_tmp12, v_tmp14);

        v_tmp0 = reduce_vector_kernel_int64<op>(v_tmp0, v_tmp4);
        v_tmp8 = reduce_vector_kernel_int64<op>(v_tmp8, v_tmp12);

        v_tmp0 = reduce_vector_kernel_int64<op>(v_tmp0, v_tmp8);
    }
    v_tmp16 = reduce_vector_kernel_int64<op>(v_tmp0, v_tmp16);
    int64_t reduce_val = init_val;
    reduce_val = reduce_scalar_kernel_int64<op>(reduce_vector_all_lanes_kernel_int64<op>(v_tmp16), reduce_val);

    dst[0] = reduce_scalar_kernel_int64<op>(dst[0], reduce_val);
}
...
static void reduce_ndarray_recursive_int64(
    ...
    if (dim_idx == src_shape->GetDimCount() - 1) {
        ...
        for (int64_t i = 0; i < len; i++) {
            const int64_t* src_ = src + i * inc_src[dim_idx];
            int64_t* dst_ = dst + i * inc_dst[dim_idx];
            reduce_ndarray_recursive_int64<op>(src_, dst_, src_shape, dst_shape, dim_idx + 1, inc_src, inc_dst);
        }
    }
}
...
ppl::common::RetCode reduce_ndarray_int64(
    ...
    reduce_ndarray_recursive_int64<op>(src, dst, src_shape, &padded_dst_shape, 0, inc_src, inc_dst);

    int64_t reduce_factor = 1;
    for (int64_t i = 0; i < dim_count; i++) {
        reduce_factor *= src_shape->GetDim(i) / padded_dst_shape.GetDim(i);
    }
    reduce_postprocess_int64<op>(dst, padded_dst_shape.GetElementsIncludingPadding(), reduce_factor);
...
#endif //  __ST_PPL_KERNEL_RISCV_INT64_REDUCE_REDUCE_NDARRAY_INT64_H_