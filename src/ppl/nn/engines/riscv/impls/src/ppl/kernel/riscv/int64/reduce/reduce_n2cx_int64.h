...
void reduce_n2cx_recursive_int64(
    ...
    if (dim_idx == src_shape->GetDimCount() - 1) {
        ...
        for (int64_t i = 0; i < len; i++) {
            ...
            reduce_n2cx_recursive_int64<op>(src + i * inc_src[dim_idx], dst + i * inc_dst[dim_idx], src_shape, dst_shape,
...
ppl::common::RetCode reduce_n2cx_int64(
    ...
    reduce_n2cx_recursive_int64<op>(src, dst, src_shape, &padded_dst_shape, 0, inc_src, inc_dst, c_dim_idx,
