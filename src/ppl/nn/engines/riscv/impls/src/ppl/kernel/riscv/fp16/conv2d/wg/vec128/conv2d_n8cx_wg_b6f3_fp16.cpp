...
inline void wg_b6f3s1_src_trans_kernel(const __fp16* src_pad,
...
inline void wg_b6f3s1_dst_trans_kernel(const __fp16* dst_trans, const __fp16* bias,
                                       const __fp16* trans_mat, // TODO: should be removed
...
ppl::common::RetCode conv2d_n8cx_wg_b6f3_fp16_runtime_executor::execute() {
    ...
    conv_shell_riscv_fp16<
        conv2d_n8cx_wg_bxfxs1_fp16_vec128_extra_param, 8, get_real_filter_size<6, 3>,
