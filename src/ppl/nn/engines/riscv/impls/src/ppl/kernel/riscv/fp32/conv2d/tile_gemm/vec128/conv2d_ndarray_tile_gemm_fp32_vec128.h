...
class conv2d_ndarray_tile_gemm_fp32_offline_manager;

struct conv2d_ndarray_tile_gemm_fp32_vec128_tunning_param {
    int64_t m_blk;
    int64_t k_blk;
    int64_t oh_blk;
    int64_t ow_blk;
...
public:
    ...
    conv2d_ndarray_tile_gemm_fp32_runtime_executor(const conv2d_common_param* conv_param, const float* cvt_filter, const float* bias, conv2d_ndarray_tile_gemm_fp32_vec128_tunning_param tunning_param)
...
private:
    conv2d_ndarray_tile_gemm_fp32_vec128_tunning_param tunning_param_;
    void adjust_tunning_param();

    friend conv2d_ndarray_tile_gemm_fp32_offline_manager;
};
