...
public:
    ...
    conv2d_n4cx_wg_b4f3_fp32_runtime_executor(const conv2d_common_param* conv_param, const float* cvt_filter,
                                              const float* bias,
...
public:
    ...
    conv2d_n4cx_wg_b4f3_fp32_offline_manager(const conv2d_common_param& param, const conv2d_common_algo_info& algo_info,
