...
#include "ppl/kernel/riscv/fp16/arithmetic/arithmetic_eltwise_fp16.h"
#include "ppl/kernel/riscv/fp16/arithmetic/arithmetic_broadcast_n8cx_fp16.h"
#include "ppl/kernel/riscv/fp16/arithmetic/arithmetic_broadcast_ndarray_fp16.h"
    ...
    __fp16* dst)
{
    ...
    if (is_eltwise) {
        return arithmetic_eltwise_fp16<_op, fuse_relu>(dst_shape, src0, src1, dst);
    } else if (dst_shape->GetDataFormat() == ppl::common::DATAFORMAT_NDARRAY) {
        return arithmetic_broadcast_ndarray_fp16<_op, fuse_relu>(src0, src1, dst, src0_shape, src1_shape, dst_shape);
    } else if (dst_shape->GetDataFormat() == ppl::common::DATAFORMAT_N8CX) {
        return arithmetic_broadcast_n8cx_fp16<_op, fuse_relu>(src0, src1, dst, src0_shape, src1_shape, dst_shape, 1);
    }
    ...
    __fp16* dst)
{
    if (fuse_relu) {
        ...
        return arithmetic_fp16<ARITHMETIC_ADD, false>(src0_shape, src1_shape, dst_shape, src0, src1, dst);
    }
}
    ...
    __fp16* dst)
{
    if (fuse_relu) {
        ...
        return arithmetic_fp16<ARITHMETIC_SUB, false>(src0_shape, src1_shape, dst_shape, src0, src1, dst);
    }
}
    ...
    __fp16* dst)
{
    if (fuse_relu) {
        ...
        return arithmetic_fp16<ARITHMETIC_MUL, false>(src0_shape, src1_shape, dst_shape, src0, src1, dst);
    }
}
    ...
    __fp16* dst)
{
    if (fuse_relu) {
        ...
        return arithmetic_fp16<ARITHMETIC_DIV, false>(src0_shape, src1_shape, dst_shape, src0, src1, dst);
    }
}
