...
static void maxpool2d_n4cx_1x16_kernel_fp32(const float* src, float* dst,
    ...
    if (w_len >= 1)
        vfmax0 = vfmvvf_float32xm1(-__FLT_MAX__, vl);
    if (w_len >= 2)
        vfmax1 = vfmax0;
    if (w_len >= 3)
        vfmax2 = vfmax0;
    ...
    for (int64_t ih = ih_start_valid; ih < ih_end_valid; ih++) {
        for (int64_t iw = iw_start_valid; iw < iw_end_valid; iw++) {
            ...
            if (w_len >= 1)
                vfmax0 = vfmaxvv_float32xm1(vfmax0, vlev_float32xm1(src_p + 0 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 2)
                vfmax1 = vfmaxvv_float32xm1(vfmax1, vlev_float32xm1(src_p + 1 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 3)
                vfmax2 = vfmaxvv_float32xm1(vfmax2, vlev_float32xm1(src_p + 2 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 4)
                vfmax3 = vfmaxvv_float32xm1(vfmax3, vlev_float32xm1(src_p + 3 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 5)
                vfmax4 = vfmaxvv_float32xm1(vfmax4, vlev_float32xm1(src_p + 4 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 6)
                vfmax5 = vfmaxvv_float32xm1(vfmax5, vlev_float32xm1(src_p + 5 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 7)
                vfmax6 = vfmaxvv_float32xm1(vfmax6, vlev_float32xm1(src_p + 6 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 8)
                vfmax7 = vfmaxvv_float32xm1(vfmax7, vlev_float32xm1(src_p + 7 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 9)
                vfmax8 = vfmaxvv_float32xm1(vfmax8, vlev_float32xm1(src_p + 8 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 10)
                vfmax9 = vfmaxvv_float32xm1(vfmax9, vlev_float32xm1(src_p + 9 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 11)
                vfmax10 = vfmaxvv_float32xm1(vfmax10, vlev_float32xm1(src_p + 10 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 12)
                vfmax11 = vfmaxvv_float32xm1(vfmax11, vlev_float32xm1(src_p + 11 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 13)
                vfmax12 = vfmaxvv_float32xm1(vfmax12, vlev_float32xm1(src_p + 12 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 14)
                vfmax13 = vfmaxvv_float32xm1(vfmax13, vlev_float32xm1(src_p + 13 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 15)
                vfmax14 = vfmaxvv_float32xm1(vfmax14, vlev_float32xm1(src_p + 14 * stride_w * C_BLK(), vl), vl);
            if (w_len >= 16)
                vfmax15 = vfmaxvv_float32xm1(vfmax15, vlev_float32xm1(src_p + 15 * stride_w * C_BLK(), vl), vl);
        }
    }

    float* dst_p = dst + (oh * dst_w + ow) * C_BLK();
    if (w_len >= 1)
        vsev_float32xm1(dst_p + 0 * C_BLK(), vfmax0, vl);
    if (w_len >= 2)
        vsev_float32xm1(dst_p + 1 * C_BLK(), vfmax1, vl);
    if (w_len >= 3)
        vsev_float32xm1(dst_p + 2 * C_BLK(), vfmax2, vl);
    if (w_len >= 4)
        vsev_float32xm1(dst_p + 3 * C_BLK(), vfmax3, vl);
    if (w_len >= 5)
        vsev_float32xm1(dst_p + 4 * C_BLK(), vfmax4, vl);
    if (w_len >= 6)
        vsev_float32xm1(dst_p + 5 * C_BLK(), vfmax5, vl);
    if (w_len >= 7)
        vsev_float32xm1(dst_p + 6 * C_BLK(), vfmax6, vl);
    if (w_len >= 8)
        vsev_float32xm1(dst_p + 7 * C_BLK(), vfmax7, vl);
    if (w_len >= 9)
        vsev_float32xm1(dst_p + 8 * C_BLK(), vfmax8, vl);
    if (w_len >= 10)
        vsev_float32xm1(dst_p + 9 * C_BLK(), vfmax9, vl);
    if (w_len >= 11)
        vsev_float32xm1(dst_p + 10 * C_BLK(), vfmax10, vl);
    if (w_len >= 12)
        vsev_float32xm1(dst_p + 11 * C_BLK(), vfmax11, vl);
    if (w_len >= 13)
        vsev_float32xm1(dst_p + 12 * C_BLK(), vfmax12, vl);
    if (w_len >= 14)
        vsev_float32xm1(dst_p + 13 * C_BLK(), vfmax13, vl);
    if (w_len >= 15)
        vsev_float32xm1(dst_p + 14 * C_BLK(), vfmax14, vl);
    if (w_len >= 16)
        vsev_float32xm1(dst_p + 15 * C_BLK(), vfmax15, vl);
}
...
static const maxpool2d_n4cx_kernel_fp32_func maxpool2d_n4cx_1x16_kernel_select[16]{
    maxpool2d_n4cx_1x16_kernel_fp32<1>,  maxpool2d_n4cx_1x16_kernel_fp32<2>,  maxpool2d_n4cx_1x16_kernel_fp32<3>,
    maxpool2d_n4cx_1x16_kernel_fp32<4>,  maxpool2d_n4cx_1x16_kernel_fp32<5>,  maxpool2d_n4cx_1x16_kernel_fp32<6>,
    maxpool2d_n4cx_1x16_kernel_fp32<7>,  maxpool2d_n4cx_1x16_kernel_fp32<8>,  maxpool2d_n4cx_1x16_kernel_fp32<9>,
    maxpool2d_n4cx_1x16_kernel_fp32<10>, maxpool2d_n4cx_1x16_kernel_fp32<11>, maxpool2d_n4cx_1x16_kernel_fp32<12>,
    maxpool2d_n4cx_1x16_kernel_fp32<13>, maxpool2d_n4cx_1x16_kernel_fp32<14>, maxpool2d_n4cx_1x16_kernel_fp32<15>,
    maxpool2d_n4cx_1x16_kernel_fp32<16>};

static inline void maxpool2d_n4cx_border_fp32(const float* src, float* dst,
...
ppl::common::RetCode maxpool2d_n4cx_1x16_fp32(const ppl::nn::TensorShape* src_shape,
    ...
    for (int64_t nc = 0; nc < batch * padded_channels; nc += C_BLK()) {
        ...
        for (int64_t oh = 0; oh < dst_h; oh++) {
            ...
            if (ow < dst_1x16_end_w) {
                maxpool2d_n4cx_1x16_kernel_select[dst_1x16_end_w - ow - 1](src_, dst_, &param, oh, ow, ih_start_valid,
                                                                           ih_end_valid);
                ow = dst_1x16_end_w;
            }
            for (; ow < dst_w; ++ow) {
