...
inline void wb_b4f3s1_cvt_filter_blk_kernel(const float* filter,
...
uint64_t conv2d_n4cx_wg_b4f3_fp32_runtime_executor::cal_temp_buffer_size() {
    ...
    size_t temp_buffer_size = conv_wg_bxfxs1_get_temp_buffer_size_fp32<4, 3>(src_shape_->GetDim(2), // src_h,
...
ppl::common::RetCode conv2d_n4cx_wg_b4f3_fp32_offline_manager::gen_cvt_weights(const float* filter, const float* bias) {
    ...
    }
    {
        ...
        conv_wg_bxfxs1_cvt_filter_fp32<4, 3, wb_b4f3s1_cvt_filter_blk_kernel>(filter, // filter,
