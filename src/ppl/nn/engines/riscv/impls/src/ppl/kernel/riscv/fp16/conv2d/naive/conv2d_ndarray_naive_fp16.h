...
#ifndef __ST_PPL_KERNEL_RISCV_FP16_CONV2D_NAIVE_GEMM_CONV2D_NDARRAY_NAIVE_FP16_H_
#define __ST_PPL_KERNEL_RISCV_FP16_CONV2D_NAIVE_GEMM_CONV2D_NDARRAY_NAIVE_FP16_H_
...
class conv2d_ndarray_naive_fp16_offline_manager;
...
private:
    ...
    friend conv2d_ndarray_naive_fp16_offline_manager;
};

class conv2d_ndarray_naive_fp16_offline_manager final : public conv2d_offline_manager<__fp16> {
public:
    conv2d_ndarray_naive_fp16_offline_manager() {}
    conv2d_ndarray_naive_fp16_offline_manager(const conv2d_common_param& param,
