...
#ifndef __ST_PPL_KERNEL_RISCV_FP32_CONV2D_NAIVE_GEMM_CONV2D_NDARRAY_NAIVE_FP32_H_
#define __ST_PPL_KERNEL_RISCV_FP32_CONV2D_NAIVE_GEMM_CONV2D_NDARRAY_NAIVE_FP32_H_
...
class conv2d_ndarray_naive_fp32_offline_manager;
...
public:
    ...
    conv2d_ndarray_naive_fp32_runtime_executor(const conv2d_common_param* conv_param, const float* cvt_filter, const float* bias)
...
private:
    ...
    friend conv2d_ndarray_naive_fp32_offline_manager;
};
