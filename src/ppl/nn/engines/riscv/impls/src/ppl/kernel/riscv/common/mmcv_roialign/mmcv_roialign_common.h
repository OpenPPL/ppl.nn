...
#ifndef __ST_PPL_KERNEL_RISCV_COMMON_MMCV_ROIALIGN_MMCV_ROIALIGN_COMMON_H_
#define __ST_PPL_KERNEL_RISCV_COMMON_MMCV_ROIALIGN_MMCV_ROIALIGN_COMMON_H_
...
#endif // __ST_PPL_KERNEL_RISCV_COMMON_MMCV_ROIALIGN_MMCV_ROIALIGN_COMMON_H_