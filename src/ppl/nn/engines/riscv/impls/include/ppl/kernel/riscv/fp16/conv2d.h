...
public:
    static conv2d_common_algo_info select_best_algo(const void* filter, ppl::common::TensorShape& src_shape, ppl::common::TensorShape& dst_shape, const conv2d_common_param& param, ppl::common::Allocator* allocator, const ppl::nn::riscv::EngineOptions* engine_options);
