    ...
    eT *dst)
{
    ...
    arithmetic_pad_shape(src0_shape, max_dim_count, padded_src0_shape);
    arithmetic_pad_shape(src1_shape, max_dim_count, padded_src1_shape);
    ...
    arithmetic_compress_shape(padded_src0_shape, padded_src1_shape, max_dim_count, &compressed_dim_count, compressed_src0_shape, compressed_src1_shape, compressed_dst_shape, c_dim_idx);

    int64_t inc0[compressed_dim_count]    = {0};
    int64_t inc1[compressed_dim_count]    = {0};
    int64_t inc_out[compressed_dim_count] = {0};
    arithmetic_nbcx_prepare_incs<c_blk>(compressed_src0_shape, compressed_src1_shape, compressed_dst_shape, compressed_dim_count, c_dim_idx, inc0, inc1, inc_out);
