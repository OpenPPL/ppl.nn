...
inline float32x4_t v_tanh_f32(const float32x4_t v_src)
{
    ...
    float32x4_t p;
    p = vfmaq_f32(vdupq_n_f32(2.00018790482477e-13f), vdupq_n_f32(-2.76076847742355e-16f), value_squared);
    p = vfmaq_f32(vdupq_n_f32(-8.60467152213735e-11f), p, value_squared);
    p = vfmaq_f32(vdupq_n_f32(5.12229709037114e-08f), p, value_squared);
    p = vfmaq_f32(vdupq_n_f32(1.48572235717979e-05f), p, value_squared);
    p = vfmaq_f32(vdupq_n_f32(6.37261928875436e-04f), p, value_squared);
    p = vfmaq_f32(vdupq_n_f32(4.89352455891786e-03f), p, value_squared);
    p = vmulq_f32(p, value);

    float32x4_t q;
    q = vfmaq_f32(vdupq_n_f32(1.18534705686654e-04f), vdupq_n_f32(1.19825839466702e-06f), value_squared);
    q = vfmaq_f32(vdupq_n_f32(2.26843463243900e-03f), q, value_squared);
    q = vfmaq_f32(vdupq_n_f32(4.89352518554385e-03f), q, value_squared);

    float32x4_t dst = vdivq_f32(p, q);
    return dst;
}
