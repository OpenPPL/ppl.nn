...
static ppl::common::RetCode hswish_common(
    ...
    void* dst)
{
    ...
    switch (data_type) {
        case ppl::common::DATATYPE_FLOAT32: return hswish_common<float>(src_shape, (const float*)src, (float*)dst);
#ifdef PPLNN_USE_ARMV8_2_FP16
        case ppl::common::DATATYPE_FLOAT16: return hswish_common<__fp16>(src_shape, (const __fp16*)src, (__fp16*)dst);
#endif
        default: break;
    }
