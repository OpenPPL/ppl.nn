...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_MAXPOOL_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_MAXPOOL_KERNEL_H_
...
class MaxPoolKernel : public ArmKernel {
public:
    MaxPoolKernel(const ir::Node* node) : ArmKernel(node) {}
