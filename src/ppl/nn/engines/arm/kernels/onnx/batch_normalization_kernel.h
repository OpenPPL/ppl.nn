...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_BATCHNORM_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_BATCHNORM_KERNEL_H_
...
class BatchNormalizationKernel : public ArmKernel {
public:
