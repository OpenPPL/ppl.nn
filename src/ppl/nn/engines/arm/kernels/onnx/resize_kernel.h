...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_RESIZE_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_RESIZE_KERNEL_H_
...
class ResizeKernel : public ArmKernel {
public:
