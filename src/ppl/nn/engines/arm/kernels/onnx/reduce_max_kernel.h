...
#ifndef _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_REDUCE_MAX_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_ARM_KERNELS_ONNX_REDUCE_MAX_KERNEL_H_
...
class ReduceMaxKernel : public ArmKernel {
public:
