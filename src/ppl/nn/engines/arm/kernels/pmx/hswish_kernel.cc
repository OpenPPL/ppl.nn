...
#include "ppl/kernel/arm_server/hswish/neon/hswish.h"

namespace ppl { namespace nn { namespace arm {

ppl::common::RetCode HSwishKernel::DoExecute(KernelExecContext* ctx) {
    ...
    return ppl::kernel::arm_server::neon::hswish(input->GetShape(), input->GetBufferPtr<void>(),
