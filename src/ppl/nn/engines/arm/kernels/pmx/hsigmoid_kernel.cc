...
#include "ppl/kernel/arm_server/hsigmoid/neon/hsigmoid.h"

namespace ppl { namespace nn { namespace arm {

ppl::common::RetCode HSigmoidKernel::DoExecute(KernelExecContext* ctx) {
    ...
    return ppl::kernel::arm_server::neon::hsigmoid(input->GetShape(), input->GetBufferPtr<void>(),
