...
#ifndef _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_ALGOS_ALGO_EINSUM_H_
#define _ST_HPC_PPL_NN_ENGINES_CUDA_OPTIMIZER_ALGOS_ALGO_EINSUM_H_
...
private:
    CudaEinSumParam attr_param_;
    std::map<dataformat_t, std::set<dataformat_t>> einsum_formats_;
};
