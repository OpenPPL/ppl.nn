...
private:
    const bool CanFuse(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options);
    const ppl::common::RetCode FuseWithPreviousPad(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options);
};
