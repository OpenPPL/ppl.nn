...
private:
    bool CanFuse(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options);
    ppl::common::RetCode FuseWithPreviousPad(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options);
};
