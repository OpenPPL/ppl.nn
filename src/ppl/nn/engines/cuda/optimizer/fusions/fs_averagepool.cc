...
bool AveragePoolFusion::CanFuse(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options) {
...
RetCode AveragePoolFusion::FuseWithPreviousPad(ir::Node* node, ir::Node* prenode, const OptKernelOptions& options) {
...
RetCode AveragePoolFusion::FuseNode(ir::Node* node, bool reliable, const OptKernelOptions& options) {
    auto topo = options.graph->topo.get();
    auto data = options.graph->data.get();
