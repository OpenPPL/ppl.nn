...
#include "ppl/nn/engines/cuda/kernels/onnx/abs_kernel.h"
using namespace std;
...
AbsOp::AbsOp(const ir::Node* node) : CudaOptKernel(node) {
...
RetCode AbsOp::Finalize(const OptKernelOptions& options) {
