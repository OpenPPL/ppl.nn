...
#include "ppl/nn/engines/cuda/kernels/onnx/sub_kernel.h"
...
RetCode SubOp::Init(const OptKernelOptions& options) {
    ...
    infer_type_func_ = [this](InputOutputInfo* info, std::vector<CudaTensorQuant>* quant, datatype_t type) -> RetCode {        ppl::common::RetCode status;
...
RetCode SubOp::Finalize(const OptKernelOptions& options) {
