...
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Add, float>(float a, float b)
{
    return a + b;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Sub, float>(float a, float b)
{
    return a - b;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Mul, float>(float a, float b)
{
    return a * b;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Div, float>(float a, float b)
{
    return a / b;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Max, float>(float a, float b)
{
    return (a > b) ? a : b;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Min, float>(float a, float b)
{
    return (a > b) ? b : a;
}
template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_Pow, float>(float a, float b)
{
    return powf(a, b);
}

template <>
__device__ inline float ppl_arithmetic_scalar<Arithmetic_PRelu, float>(float a, float b)
{
    float res = a;
    res       = (a > 0) ? res : res * b;
    return res;
...
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Add, int64_t>(int64_t a, int64_t b)
{
    return a + b;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Sub, int64_t>(int64_t a, int64_t b)
{
    return a - b;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Mul, int64_t>(int64_t a, int64_t b)
{
    return a * b;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Div, int64_t>(int64_t a, int64_t b)
{
    return a / b;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Max, int64_t>(int64_t a, int64_t b)
{
    return (a > b) ? a : b;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Min, int64_t>(int64_t a, int64_t b)
{
    return (a > b) ? b : a;
}
template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_Pow, int64_t>(int64_t a, int64_t b)
{
    return powf(a, b);
}

template <>
__device__ inline int64_t ppl_arithmetic_scalar<Arithmetic_PRelu, int64_t>(int64_t a, int64_t b)
{
    int64_t res = a;
    res         = (a > 0) ? res : res * b;
    return res;
...
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Add, int32_t>(int32_t a, int32_t b)
{
    return a + b;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Sub, int32_t>(int32_t a, int32_t b)
{
    return a - b;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Mul, int32_t>(int32_t a, int32_t b)
{
    return a * b;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Div, int32_t>(int32_t a, int32_t b)
{
    return a / b;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Max, int32_t>(int32_t a, int32_t b)
{
    return (a > b) ? a : b;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Min, int32_t>(int32_t a, int32_t b)
{
    return (a > b) ? b : a;
}
template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_Pow, int32_t>(int32_t a, int32_t b)
{
    return powf(a, b);
}

template <>
__device__ inline int32_t ppl_arithmetic_scalar<Arithmetic_PRelu, int32_t>(int32_t a, int32_t b)
{
    int32_t res = a;
    res         = (a > 0) ? res : res * b;
    return res;
                                      ...
                                      bool &bidirectional)
{
    ...
    if (fisrt_broadcast > 0 && second_broadcast > 0)
        bidirectional = true;
    ...
    T *output)
{
    ...
    if (!bidirectional && ((input_shape0->GetDimCount() < 2) || (input_shape1->GetDimCount() < 2))) {
        ...
        if (input_shape0->GetElementsIncludingPadding() == 1 || input_shape1->GetElementsIncludingPadding() == 1) {
            ppl_cukernel_arithmetic_one_scalar<op_type, T><<<grid_size, block_size, 0, stream>>>(num_elems, first_shorter, (const T *)input0, (const T *)input1, (T *)output);
        } else {
            int inner_dim = output_shape->GetElementsIncludingPadding() / input_shape0->GetDim(0);
            ppl_cukernel_arithmetic_one_dimension<op_type, T><<<grid_size, block_size, 0, stream>>>(num_elems, inner_dim, first_shorter, (const T *)input0, (const T *)input1, (T *)output);
        }
    } else if (num_broadcast_dims == 0) {
        ppl_cukernel_arithmetic_nobroadcast<op_type, T><<<grid_size, block_size, 0, stream>>>(num_elems, (const T *)input0, (const T *)input1, (T *)output);
    } else {
        ArithmeticParam param;
        ...
        if (output_shape->GetDataFormat() == ppl::common::DATAFORMAT_NHWC8) {
            if (output_shape->GetDataType() == ppl::common::DATATYPE_FLOAT16) {
                ...
                if (ppl_feature_broadcast(input_shape0, input_shape1, &axis)) {
                    ...
                    ppl_cukernel_arithmetic_one_broadcast<op_type, half><<<grid_size, block_size, 0, stream>>>(num_elems, outer_stride, inner_dim, first_shorter, (const half *)input0, (const half *)input1, (half *)output);
            ...
            if (num_broadcast_dims == 1) {
                ...
                ppl_cukernel_arithmetic_one_broadcast<op_type, T><<<grid_size, block_size, 0, stream>>>(num_elems, outer_stride, inner_dim, first_shorter, (const T *)input0, (const T *)input1, (T *)output);
                return ppl::common::RC_SUCCESS;
            }
            ppl_arithmetic_prepare_strides(input_shape0, input_shape1, output_shape, packed_channel, param.stride_in0, param.stride_in1, param.stride_out);
            ppl_cukernel_arithmetic<op_type, T><<<grid_size, block_size, 0, stream>>>(num_elems, dim_count, param, (const T *)input0, (const T *)input1, (T *)output);
        } else {
