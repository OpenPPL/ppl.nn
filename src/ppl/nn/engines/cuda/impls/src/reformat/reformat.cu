        ...
        switch (GetSizeOfDataType(param.out_type)) {                                                            \
            case 1:                                                                                             \
                cuda_kernel_small_channel_cvtformat<char, mode><<<dimGrid, dimBlock, 0, stream>>>(              \
                    (char*)input, num_elems, inner_fast, src_pad_fast, dst_pad_fast, (char*)output, param);     \
                break;                                                                                          \
            case 2:                                                                                             \
                cuda_kernel_small_channel_cvtformat<half, mode><<<dimGrid, dimBlock, 0, stream>>>(              \
                    (half*)input, num_elems, inner_fast, src_pad_fast, dst_pad_fast, (half*)output, param);     \
                break;                                                                                          \
            case 4:                                                                                             \
                cuda_kernel_small_channel_cvtformat<float, mode><<<dimGrid, dimBlock, 0, stream>>>(             \
                    (float*)input, num_elems, inner_fast, src_pad_fast, dst_pad_fast, (float*)output, param);   \
                break;                                                                                          \
            case 8:                                                                                             \
                cuda_kernel_small_channel_cvtformat<double, mode><<<dimGrid, dimBlock, 0, stream>>>(            \
                    (double*)input, num_elems, inner_fast, src_pad_fast, dst_pad_fast, (double*)output, param); \
                break;                                                                                          \
            default:                                                                                            \
                break;                                                                                          \
        }                                                                                                       \
