    ...
    int axis)
{
    ...
    #define SWITCH_CASE(TYPE)                                                                                        \
        case sizeof(TYPE): {                                                                                         \
            ppl_cukernel_gather<<<grid_size, block_size, 0, stream>>>(num_elems, output_outer_block_fast,            \
                    input_axis_size, output_inner_block_fast, (const TYPE *)input, (TYPE *)output,                   \
