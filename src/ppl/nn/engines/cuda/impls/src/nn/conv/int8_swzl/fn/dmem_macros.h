...
#define SET_dBv4_BOUND(_step_id, _dBv4_off, _flt_n_valid) \
        { \
            int _flt_n_id  =  cta_idy *  TILE_N_PER_CTA + \
...
#define SET_dAv4_BOUND(_step_id, _dAv4_off, _in_n_id, _in_h_start, _in_w_start) \
        { \
            int _out_nhw_id    = cta_idx  *  TILE_M_PER_CTA + \
...
#define LOAD_dAv4_SIZE32(_regA, _dA, _dAv4_off, _in_n_id, _in_h_id, _in_w_id) \
        { \
            ...
            _regA[14] = (flt_c_v16_valid && HeightInRange(_in_h_id[14]) && WidthInRange(_in_w_id[14]) && (_in_n_id[14] < in_num)) ? _dA[ _dAv4_off[14] ] : ZEROv4;\
            _regA[15] = (flt_c_v16_valid && HeightInRange(_in_h_id[15]) && WidthInRange(_in_w_id[15]) && (_in_n_id[15] < in_num)) ? _dA[ _dAv4_off[15] ] : ZEROv4;\
            _regA[16] = (flt_c_v16_valid && HeightInRange(_in_h_id[16]) && WidthInRange(_in_w_id[16]) && (_in_n_id[16] < in_num)) ? _dA[ _dAv4_off[16] ] : ZEROv4;\
            _regA[17] = (flt_c_v16_valid && HeightInRange(_in_h_id[17]) && WidthInRange(_in_w_id[17]) && (_in_n_id[17] < in_num)) ? _dA[ _dAv4_off[17] ] : ZEROv4;\
            _regA[18] = (flt_c_v16_valid && HeightInRange(_in_h_id[18]) && WidthInRange(_in_w_id[18]) && (_in_n_id[18] < in_num)) ? _dA[ _dAv4_off[18] ] : ZEROv4;\
            _regA[19] = (flt_c_v16_valid && HeightInRange(_in_h_id[19]) && WidthInRange(_in_w_id[19]) && (_in_n_id[19] < in_num)) ? _dA[ _dAv4_off[19] ] : ZEROv4;\
            _regA[20] = (flt_c_v16_valid && HeightInRange(_in_h_id[20]) && WidthInRange(_in_w_id[20]) && (_in_n_id[20] < in_num)) ? _dA[ _dAv4_off[20] ] : ZEROv4;\
            _regA[21] = (flt_c_v16_valid && HeightInRange(_in_h_id[21]) && WidthInRange(_in_w_id[21]) && (_in_n_id[21] < in_num)) ? _dA[ _dAv4_off[21] ] : ZEROv4;\
            _regA[22] = (flt_c_v16_valid && HeightInRange(_in_h_id[22]) && WidthInRange(_in_w_id[22]) && (_in_n_id[22] < in_num)) ? _dA[ _dAv4_off[22] ] : ZEROv4;\
            _regA[23] = (flt_c_v16_valid && HeightInRange(_in_h_id[23]) && WidthInRange(_in_w_id[23]) && (_in_n_id[23] < in_num)) ? _dA[ _dAv4_off[23] ] : ZEROv4;\
            _regA[24] = (flt_c_v16_valid && HeightInRange(_in_h_id[24]) && WidthInRange(_in_w_id[24]) && (_in_n_id[24] < in_num)) ? _dA[ _dAv4_off[24] ] : ZEROv4;\
            _regA[25] = (flt_c_v16_valid && HeightInRange(_in_h_id[25]) && WidthInRange(_in_w_id[25]) && (_in_n_id[25] < in_num)) ? _dA[ _dAv4_off[25] ] : ZEROv4;\
            _regA[26] = (flt_c_v16_valid && HeightInRange(_in_h_id[26]) && WidthInRange(_in_w_id[26]) && (_in_n_id[26] < in_num)) ? _dA[ _dAv4_off[26] ] : ZEROv4;\
            _regA[27] = (flt_c_v16_valid && HeightInRange(_in_h_id[27]) && WidthInRange(_in_w_id[27]) && (_in_n_id[27] < in_num)) ? _dA[ _dAv4_off[27] ] : ZEROv4;\
            _regA[28] = (flt_c_v16_valid && HeightInRange(_in_h_id[28]) && WidthInRange(_in_w_id[28]) && (_in_n_id[28] < in_num)) ? _dA[ _dAv4_off[28] ] : ZEROv4;\
            _regA[29] = (flt_c_v16_valid && HeightInRange(_in_h_id[29]) && WidthInRange(_in_w_id[29]) && (_in_n_id[29] < in_num)) ? _dA[ _dAv4_off[29] ] : ZEROv4;\
            _regA[30] = (flt_c_v16_valid && HeightInRange(_in_h_id[30]) && WidthInRange(_in_w_id[30]) && (_in_n_id[30] < in_num)) ? _dA[ _dAv4_off[30] ] : ZEROv4;\
            _regA[31] = (flt_c_v16_valid && HeightInRange(_in_h_id[31]) && WidthInRange(_in_w_id[31]) && (_in_n_id[31] < in_num)) ? _dA[ _dAv4_off[31] ] : ZEROv4;\
        }
