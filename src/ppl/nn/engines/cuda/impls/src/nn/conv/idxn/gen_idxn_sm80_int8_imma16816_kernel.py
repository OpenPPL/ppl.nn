...
class KernelInfo:
    def __init__(self, path, s_size, k_num, cta_y_num, cta_x_num, warp_y, warp_x):
        ...
        self.kname = "nvIdxnSm80Int8Conv_imma16816_nhwc" + self.kconfig
    ...
    def GetCompGmemRatio(self):
        ...
        cycles_imma = (self.CPI_IMMA16816 * (self.cta_y / self.MMA_Y) * (self.cta_x / self.MMA_X) * (self.s_size / self.MMA_K) / pb_num_per_cta) + self.IMMA_LATENCY
    ...
    def GenKernel(self):
        ...
        if self.s_size == 16:
            ...
            f.write("#include \"idxn/int8/imma16816_i1_macros.h\"\n\n")
            ...
            f.write("#include \"idxn/int8/imma16816_i2_macros.h\"\n\n")
            ...
            f.write("#include \"idxn/int8/imma16816_i4_macros.h\"\n\n")
...
class IdxSourceFile:
    def __init__(self, path):
        ...
        self.f.write("#include  \"idxn/sm80/int8/imma16816/idxn_kernels.h\"\n\n")

        self.f.write("#define ENABLE_FUSE\n\n")

    def AppendKernel(self, fname):
        self.f.write("#include \"idxn/sm80/int8/imma16816/%s\"\n" % fname)
...
class IdxHeaderFile:
    def __init__(self, path):
        ...
        self.f.write("#ifndef __PPLCUDA_IDXN_SM80_INT8_IMMA16816_KERNELS_H__\n")
        self.f.write("#define __PPLCUDA_IDXN_SM80_INT8_IMMA16816_KERNELS_H__\n")
...
class InitFile:
    def __init__(self, path):
        ...
        self.f.write("void InitializeIdxnSM80Int8Imma16816ConvKernelContainer(std::vector<kernel_info_t> & kernel_container)\n{\n")
