...
#pragma unroll
...
#if TILE_K_PER_CTA == 32
    uint ldsa_idx = ((set_id * TILE_K_V16_PER_SET) & 0x1) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x1) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V16_PER_SET) & 0x1) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x1) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 64
    uint ldsa_idx = ((set_id * TILE_K_V16_PER_SET) & 0x3) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x3) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V16_PER_SET) & 0x3) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x3) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 128
    uint ldsa_idx = ((set_id * TILE_K_V16_PER_SET) & 0x7) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V16_PER_SET) & 0x7) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x7) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 256
    uint ldsa_idx = ((set_id * TILE_K_V16_PER_SET) & 0xf) ^ (local_tid & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V16_PER_SET) & 0xf) ^ (local_tid & 0x7) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 512
    uint ldsa_idx = ((set_id * TILE_K_V16_PER_SET) & 0x1f) ^ (local_tid & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V16_PER_SET) & 0x1f) ^ (local_tid & 0x7) ^ ((local_tid & 0x8) >> 3);
#endif
    ...
    uint sBv1_read  =  set_widx   * TILE_N_PER_WARP        * TILE_K_V4_PER_CTA +
                      ...
                      (ldsb_idy   % WARP_SIZE_IN_THD_QTR)  * TILE_K_V4_PER_CTA +
#elif TILE_N_PER_WARP == 16
                      (ldsb_idy   % WARP_SIZE_IN_THD_HALF) * TILE_K_V4_PER_CTA +
...
#if TILE_K_PER_SET == 64 || TILE_K_PER_SET == 128
