...
#define TILE_N_PER_MMA_QTR      (TILE_N_PER_MMA / 4)
#define TILE_N_PER_MMA_8TH      (TILE_N_PER_MMA / 8)
...
#define M_ROWS_PER_SMEM_ROW     (SMEM_ROW_V4_SIZE / TILE_M_V4_PER_CTA)
...
#define OUTPUT_SIZE_Y_IN_THD    (TILE_M_V4_PER_WARP)
...
#define   C_ITEMS_PER_THD       ((TILE_M_PER_CTA) * (TILE_N_PER_CTA) / (CTA_SIZE_IN_THD))
#define Cv4_ITEMS_PER_THD       ((TILE_M_PER_CTA) * (TILE_N_PER_CTA) / (CTA_SIZE_IN_THD * _4INT_TO_INT4_))
...
#define SM_C_SIZE               ((TILE_M_PER_CTA) * (TILE_N_PER_MMA) * (CTA_SIZE_X_IN_WARP) * (_2MMA_) / (_1INT_))
#elif TILE_M_PER_WARP == 16 || TILE_M_PER_WARP == 32 || TILE_M_PER_WARP == 64
#define SM_C_SIZE               ((TILE_M_PER_CTA) * (TILE_N_PER_MMA) * (CTA_SIZE_X_IN_WARP) / (_1INT_))
#endif
