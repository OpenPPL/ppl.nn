...
#define LOAD_dAv4_SIZE32(_regA, _dA, _dAv4_off, _in_c_v8_valid, _in_hw_valid)           \
    {                                                                                   \
        _regA[0]  = (_in_hw_valid[0] && _in_c_v8_valid) ? _dA[_dAv4_off[0]] : ZEROv4;   \
        _regA[1]  = (_in_hw_valid[1] && _in_c_v8_valid) ? _dA[_dAv4_off[1]] : ZEROv4;   \
        _regA[2]  = (_in_hw_valid[2] && _in_c_v8_valid) ? _dA[_dAv4_off[2]] : ZEROv4;   \
        ...
        _regA[14] = (_in_hw_valid[14] && _in_c_v8_valid) ? _dA[_dAv4_off[14]] : ZEROv4; \
        _regA[15] = (_in_hw_valid[15] && _in_c_v8_valid) ? _dA[_dAv4_off[15]] : ZEROv4; \
        _regA[16] = (_in_hw_valid[16] && _in_c_v8_valid) ? _dA[_dAv4_off[16]] : ZEROv4; \
        _regA[17] = (_in_hw_valid[17] && _in_c_v8_valid) ? _dA[_dAv4_off[17]] : ZEROv4; \
        _regA[18] = (_in_hw_valid[18] && _in_c_v8_valid) ? _dA[_dAv4_off[18]] : ZEROv4; \
        _regA[19] = (_in_hw_valid[19] && _in_c_v8_valid) ? _dA[_dAv4_off[19]] : ZEROv4; \
        _regA[20] = (_in_hw_valid[20] && _in_c_v8_valid) ? _dA[_dAv4_off[20]] : ZEROv4; \
        _regA[21] = (_in_hw_valid[21] && _in_c_v8_valid) ? _dA[_dAv4_off[21]] : ZEROv4; \
        _regA[22] = (_in_hw_valid[22] && _in_c_v8_valid) ? _dA[_dAv4_off[22]] : ZEROv4; \
        _regA[23] = (_in_hw_valid[23] && _in_c_v8_valid) ? _dA[_dAv4_off[23]] : ZEROv4; \
        _regA[24] = (_in_hw_valid[24] && _in_c_v8_valid) ? _dA[_dAv4_off[24]] : ZEROv4; \
        _regA[25] = (_in_hw_valid[25] && _in_c_v8_valid) ? _dA[_dAv4_off[25]] : ZEROv4; \
        _regA[26] = (_in_hw_valid[26] && _in_c_v8_valid) ? _dA[_dAv4_off[26]] : ZEROv4; \
        _regA[27] = (_in_hw_valid[27] && _in_c_v8_valid) ? _dA[_dAv4_off[27]] : ZEROv4; \
        _regA[28] = (_in_hw_valid[28] && _in_c_v8_valid) ? _dA[_dAv4_off[28]] : ZEROv4; \
        _regA[29] = (_in_hw_valid[29] && _in_c_v8_valid) ? _dA[_dAv4_off[29]] : ZEROv4; \
        _regA[30] = (_in_hw_valid[30] && _in_c_v8_valid) ? _dA[_dAv4_off[30]] : ZEROv4; \
        _regA[31] = (_in_hw_valid[31] && _in_c_v8_valid) ? _dA[_dAv4_off[31]] : ZEROv4; \
                                                                                        \
        _dAv4_off[0] += TILE_K_V8_PER_CTA;                                              \
        _dAv4_off[1] += TILE_K_V8_PER_CTA;                                              \
        _dAv4_off[2] += TILE_K_V8_PER_CTA;                                              \
