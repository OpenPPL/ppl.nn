...
class KernelInfo:
    def __init__(self, path, flt_size, k_size, cta_y_num, cta_x_num, warp_y, warp_x, buf_size):
        ...
        self.kname = "nvSwzlSm80Int8Conv_imma8816_nhwc_" + self.flt_size + self.kconfig
...
class LutSourceFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#include  \"swzl/sm80/int8/imma8816/%s_lut_kernels.h\"\n\n" % flt_size)

        self.f.write("#define ENABLE_FUSE\n\n")

    def AppendKernel(self, fname):
        self.f.write("#include \"swzl/sm80/int8/imma8816/%s\"\n" % fname)
...
class SpkSourceFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#include  \"swzl/sm80/int8/imma8816/%s_spk_kernels.h\"\n\n" % flt_size)
...
class LutHeaderFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#ifndef __PPLCUDA_SWZL_SM80_INT8_IMMA8816_%s_LUT_KERNELS_H__\n" % flt_size.upper())
        self.f.write("#define __PPLCUDA_SWZL_SM80_INT8_IMMA8816_%s_LUT_KERNELS_H__\n" % flt_size.upper())
...
class SpkHeaderFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#ifndef __PPLCUDA_SWZL_SM80_INT8_IMMA8816_%s_SPK_KERNELS_H__\n" % flt_size.upper())
        self.f.write("#define __PPLCUDA_SWZL_SM80_INT8_IMMA8816_%s_SPK_KERNELS_H__\n" % flt_size.upper())
...
class InitFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("void InitializeSwzlSM80Int8Imma8816Conv%sKernelContainer(std::vector<kernel_info_t> & kernel_container)\n{\n" % self.flt_size.upper())
