...
#define LOAD_dAv4_SIZE16(_regA, _dAv4, _in_id, _in_off)                                                          \
    {                                                                                                            \
        int4 _in;                                                                                                \
                                                                                                                 \
        _in.x    = _in_id[0].x + _in_off.x;                                                                      \
