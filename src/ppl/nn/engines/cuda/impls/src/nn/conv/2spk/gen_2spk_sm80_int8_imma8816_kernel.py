...
class KernelInfo:
    def __init__(self, path, flt_size, s_size, k_num, cta_y_num, cta_x_num, warp_y, warp_x, buf_size):
        ...
        self.kname = "nv2spkSm80Int8Conv_imma8816_nhwc_" + self.flt_size + self.kconfig
...
class LutSourceFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#include  \"2spk/sm80/int8/imma8816/%s_lut_kernels.h\"\n\n" % flt_size)
    ...
    def AppendKernel(self, fname):
        self.f.write("#include \"2spk/sm80/int8/imma8816/%s\"\n" % fname)
...
class SpkSourceFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#include  \"2spk/sm80/int8/imma8816/%s_spk_kernels.h\"\n\n" % flt_size)
...
class LutHeaderFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#ifndef __PPLCUDA_2SPK_SM80_INT8_IMMA8816_%s_LUT_KERNELS_H__\n" % flt_size.upper())
        self.f.write("#define __PPLCUDA_2SPK_SM80_INT8_IMMA8816_%s_LUT_KERNELS_H__\n" % flt_size.upper())
...
class SpkHeaderFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("#ifndef __PPLCUDA_2SPK_SM80_INT8_IMMA8816_%s_SPK_KERNELS_H__\n" % flt_size.upper())
        self.f.write("#define __PPLCUDA_2SPK_SM80_INT8_IMMA8816_%s_SPK_KERNELS_H__\n" % flt_size.upper())
...
class InitFile:
    def __init__(self, path, flt_size):
        ...
        self.f.write("void Initialize2spkSM80Int8Imma8816Conv%sKernelContainer(std::vector<kernel_info_t> & kernel_container)\n{\n" % self.flt_size.upper())
