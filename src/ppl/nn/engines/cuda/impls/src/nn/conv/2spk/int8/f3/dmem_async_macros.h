...
#define LOAD_dAv4_SIZE_16TH(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 16 ))  \
                CP_ASYNC( ((_flt_hw_bid & in_hw_mask[0]) && _in_c_v16_valid), _sAv4, _sAv4_off, _dA, _dAv4_off[0]); \
        }

#define LOAD_dAv4_SIZE_8TH(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 8 ))  \
...
#define LOAD_dAv4_SIZE_QTR(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 4 ))  \
...
#define LOAD_dAv4_SIZE_HALF(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            \
            if(tid < ( CTA_SIZE_IN_THD / 2 ))  \
...
#define LOAD_dAv4_SIZE1(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[0]) && _in_c_v16_valid), _sAv4, _sAv4_off, _dA, _dAv4_off[0]); \
...
#define LOAD_dAv4_SIZE2(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            _dAv4_off[1] += in_lut.idx[lut_id]; \
            \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[0]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 0, _dA, _dAv4_off[0]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[1]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 1, _dA, _dAv4_off[1]); \
        }

#define LOAD_dAv4_SIZE4(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            _dAv4_off[1] += in_lut.idx[lut_id]; \
            ...
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[0]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 0, _dA, _dAv4_off[0]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[1]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 1, _dA, _dAv4_off[1]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[2]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 2, _dA, _dAv4_off[2]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[3]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 3, _dA, _dAv4_off[3]); \
        }

#define LOAD_dAv4_SIZE8(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0] += in_lut.idx[lut_id]; \
            _dAv4_off[1] += in_lut.idx[lut_id]; \
            _dAv4_off[2] += in_lut.idx[lut_id]; \
            ...
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[2]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 2, _dA, _dAv4_off[2]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[3]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 3, _dA, _dAv4_off[3]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[4]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 4, _dA, _dAv4_off[4]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[5]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 5, _dA, _dAv4_off[5]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[6]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 6, _dA, _dAv4_off[6]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[7]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 7, _dA, _dAv4_off[7]); \
        }

#define LOAD_dAv4_SIZE16(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0]  += in_lut.idx[lut_id]; \
            _dAv4_off[1]  += in_lut.idx[lut_id]; \
            _dAv4_off[2]  += in_lut.idx[lut_id]; \
            ...
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[6])  && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 6,  _dA, _dAv4_off[6]);  \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[7])  && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 7,  _dA, _dAv4_off[7]);  \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[8])  && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 8,  _dA, _dAv4_off[8]);  \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[9])  && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 9,  _dA, _dAv4_off[9]);  \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[10]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 10, _dA, _dAv4_off[10]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[11]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 11, _dA, _dAv4_off[11]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[12]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 12, _dA, _dAv4_off[12]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[13]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 13, _dA, _dAv4_off[13]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[14]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 14, _dA, _dAv4_off[14]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[15]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 15, _dA, _dAv4_off[15]); \
        }

#define LOAD_dAv4_SIZE32(_sAv4, _sAv4_off, _dA, _dAv4_off, _in_c_v16_valid, _flt_hw_bid) \
        { \
            _dAv4_off[0]  += in_lut.idx[lut_id]; \
            _dAv4_off[1]  += in_lut.idx[lut_id]; \
            _dAv4_off[2]  += in_lut.idx[lut_id]; \
            ...
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[14]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 14, _dA, _dAv4_off[14]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[15]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 15, _dA, _dAv4_off[15]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[16]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 16, _dA, _dAv4_off[16]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[17]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 17, _dA, _dAv4_off[17]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[18]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 18, _dA, _dAv4_off[18]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[19]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 19, _dA, _dAv4_off[19]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[20]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 20, _dA, _dAv4_off[20]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[21]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 21, _dA, _dAv4_off[21]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[22]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 22, _dA, _dAv4_off[22]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[23]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 23, _dA, _dAv4_off[23]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[24]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 24, _dA, _dAv4_off[24]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[25]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 25, _dA, _dAv4_off[25]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[26]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 26, _dA, _dAv4_off[26]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[27]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 27, _dA, _dAv4_off[27]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[28]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 28, _dA, _dAv4_off[28]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[29]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 29, _dA, _dAv4_off[29]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[30]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 30, _dA, _dAv4_off[30]); \
            CP_ASYNC( ((_flt_hw_bid & in_hw_mask[31]) && _in_c_v16_valid), _sAv4, _sAv4_off + CTA_SIZE_IN_THD * 31, _dA, _dAv4_off[31]); \
        }
