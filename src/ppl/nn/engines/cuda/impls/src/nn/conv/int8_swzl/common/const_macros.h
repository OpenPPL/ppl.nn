...
//#define Cv4_ITEMS_PER_THD       ((TILE_M_PER_CTA) * (TILE_N_PER_CTA) / (CTA_SIZE_IN_THD * _4CHAR_TO_INT_ * _4INT_TO_INT4_))
...
#define SM_C_SIZE               ((CTA_SIZE_Y_IN_WARP)*(TILE_M_PER_SUB_MMA) * (TILE_N_PER_CTA) / (_1INT_))
