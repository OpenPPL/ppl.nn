...
#define LOAD_dBv4_SIZE1(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( flt_n_valid[0] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            \
            flt_hwc_v16_acc  += TILE_K_V16_PER_STEP; \
        }

#define LOAD_dBv4_SIZE2(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( flt_n_valid[0] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            _regB[1] = ( flt_n_valid[1] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[1] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            _dBv4_off[1] += TILE_K_V16_PER_STEP; \
            \
            flt_hwc_v16_acc  += TILE_K_V16_PER_STEP; \
        }
...
#define LOAD_dBv4_SIZE4(_regB, _dBv4, _dBv4_off) \
        { \
            _regB[0] = ( flt_n_valid[0] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[0] ] : ZEROv4;\
            _regB[1] = ( flt_n_valid[1] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[1] ] : ZEROv4;\
            _regB[2] = ( flt_n_valid[2] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[2] ] : ZEROv4;\
            _regB[3] = ( flt_n_valid[3] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[3] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            _dBv4_off[1] += TILE_K_V16_PER_STEP; \
            _dBv4_off[2] += TILE_K_V16_PER_STEP; \
            _dBv4_off[3] += TILE_K_V16_PER_STEP; \
            \
            flt_hwc_v16_acc  += TILE_K_V16_PER_STEP; \
        }
...
#define LOAD_dBv4_SIZE8(_regB, _dBv4, _dBv4_off) \
        { \
            ...
            _regB[2] = ( flt_n_valid[2] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[2] ] : ZEROv4;\
            _regB[3] = ( flt_n_valid[3] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[3] ] : ZEROv4;\
            _regB[4] = ( flt_n_valid[4] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[4] ] : ZEROv4;\
            _regB[5] = ( flt_n_valid[5] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[5] ] : ZEROv4;\
            _regB[6] = ( flt_n_valid[6] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[6] ] : ZEROv4;\
            _regB[7] = ( flt_n_valid[7] && (flt_hwc_v16_acc < flt_hwc_v16) ) ? _dBv4[ _dBv4_off[7] ] : ZEROv4;\
            \
            _dBv4_off[0] += TILE_K_V16_PER_STEP; \
            _dBv4_off[1] += TILE_K_V16_PER_STEP; \
            _dBv4_off[2] += TILE_K_V16_PER_STEP; \
            _dBv4_off[3] += TILE_K_V16_PER_STEP; \
            _dBv4_off[4] += TILE_K_V16_PER_STEP; \
            _dBv4_off[5] += TILE_K_V16_PER_STEP; \
            _dBv4_off[6] += TILE_K_V16_PER_STEP; \
            _dBv4_off[7] += TILE_K_V16_PER_STEP; \
            \
            flt_hwc_v16_acc  += TILE_K_V16_PER_STEP; \
        }
...
#define SET_dBv4_BOUND(_step_id, _dBv4_off, _flt_n_valid) \
        { \
            ...
            \
            _dBv4_off  =   grp_id   * flt_hwc_v16 * num_flt_per_grp + \
                          _flt_n_id  * flt_hwc_v16 + \
                           tid_x; \
        }
...
#define LOAD_dAv4_SIZE1(_regA, _dAv4, _inId, _inOff) \
        { \
            int4 _in; \
            \
            _in.x =  _inId[0].x + _inOff.x; \
...
#define LOAD_dAv4_SIZE2(_regA, _dAv4, _inId, _inOff) \
        { \
            int4 _in; \
            \
            _in.x =  _inId[0].x + _inOff.x; \
...
#define LOAD_dAv4_SIZE4(_regA, _dAv4, _inId, _inOff) \
        { \
            int4 _in; \
            \
            _in.x =  _inId[0].x + _inOff.x; \
...
#define LOAD_dAv4_SIZE8(_regA, _dAv4, _inId, _inOff) \
        { \
            int4 _in; \
            \
            _in.x =  _inId[0].x + _inOff.x; \
...
#define LOAD_dAv4_SIZE16(_regA, _dAv4, _inId, _inOff) \
        { \
            int4 _in; \
            \
            _in.x =  _inId[0].x + _inOff.x; \
            ...
            _regA[7] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[8].x + _inOff.x; \
            _in.y =  _inId[8].y + _inOff.y; \
            _in.z =  _inId[8].z + _inOff.z; \
            _in.w =  _inId[8].w + _inOff.w; \
            _regA[8] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[9].x + _inOff.x; \
            _in.y =  _inId[9].y + _inOff.y; \
            _in.z =  _inId[9].z + _inOff.z; \
            _in.w =  _inId[9].w + _inOff.w; \
            _regA[9] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[10].x + _inOff.x; \
            _in.y =  _inId[10].y + _inOff.y; \
            _in.z =  _inId[10].z + _inOff.z; \
            _in.w =  _inId[10].w + _inOff.w; \
            _regA[10] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[11].x + _inOff.x; \
            _in.y =  _inId[11].y + _inOff.y; \
            _in.z =  _inId[11].z + _inOff.z; \
            _in.w =  _inId[11].w + _inOff.w; \
            _regA[11] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[12].x + _inOff.x; \
            _in.y =  _inId[12].y + _inOff.y; \
            _in.z =  _inId[12].z + _inOff.z; \
            _in.w =  _inId[12].w + _inOff.w; \
            _regA[12] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[13].x + _inOff.x; \
            _in.y =  _inId[13].y + _inOff.y; \
            _in.z =  _inId[13].z + _inOff.z; \
            _in.w =  _inId[13].w + _inOff.w; \
            _regA[13] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[14].x + _inOff.x; \
            _in.y =  _inId[14].y + _inOff.y; \
            _in.z =  _inId[14].z + _inOff.z; \
            _in.w =  _inId[14].w + _inOff.w; \
            _regA[14] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
            \
            _in.x =  _inId[15].x + _inOff.x; \
            _in.y =  _inId[15].y + _inOff.y; \
            _in.z =  _inId[15].z + _inOff.z; \
            _in.w =  _inId[15].w + _inOff.w; \
            _regA[15] = ( BatchInRange(_in.w) && WidthInRange(_in.y) && HeightInRange(_in.z) ) ? _dAv4[_in.x] : ZEROv4;\
        }
