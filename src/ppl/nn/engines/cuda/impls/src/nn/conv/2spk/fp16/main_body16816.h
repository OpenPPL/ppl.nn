...
#pragma unroll
    ...
    uint sts_idx   = ((tid & 0x1f) ^ ((tid & 0xff) >> 5));
    uint sts_idy   = tid >> 5;
#endif
...
#pragma unroll
    ...
    uint ldsa_idy =   local_tid & 0xf;
    uint ldsb_idy = ((local_tid & 0x10) >> 1) + (local_tid & 0x7);

#if TILE_K_PER_CTA == 16
    uint ldsa_idx = ((set_id * TILE_K_V8_PER_SET) & 0x1) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x1) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V8_PER_SET) & 0x1) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x1) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 32
    uint ldsa_idx = ((set_id * TILE_K_V8_PER_SET) & 0x3) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x3) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V8_PER_SET) & 0x3) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x3) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 64
    uint ldsa_idx = ((set_id * TILE_K_V8_PER_SET) & 0x7) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V8_PER_SET) & 0x7) ^ ((local_tid / K_ROWS_PER_SMEM_ROW) & 0x7) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 128
    uint ldsa_idx = ((set_id * TILE_K_V8_PER_SET) & 0xf) ^ (local_tid & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V8_PER_SET) & 0xf) ^ (local_tid & 0x7) ^ ((local_tid & 0x8) >> 3);
#elif TILE_K_PER_CTA == 256
    uint ldsa_idx = ((set_id * TILE_K_V8_PER_SET) & 0x1f) ^ (local_tid & 0x7) ^  (local_tid >> 4);
    uint ldsb_idx = ((set_id * TILE_K_V8_PER_SET) & 0x1f) ^ (local_tid & 0x7) ^ ((local_tid & 0x8) >> 3);
#endif

    uint sAv1_read  =  set_widy   * TILE_M_PER_WARP        * TILE_K_V2_PER_CTA +
#if TILE_M_PER_WARP == 16
                      (ldsa_idy   % WARP_SIZE_IN_THD_HALF) * TILE_K_V2_PER_CTA +
#elif TILE_M_PER_WARP == 32
                       ldsa_idy   * TILE_K_V2_PER_CTA      +
    ...
    uint sBv1_read  =  set_widx   * TILE_N_PER_WARP        * TILE_K_V2_PER_CTA +
                      ...
                      (ldsb_idy   % WARP_SIZE_IN_THD_QTR)  * TILE_K_V2_PER_CTA +
#elif TILE_N_PER_WARP == 16
                      (ldsb_idy   % WARP_SIZE_IN_THD_HALF) * TILE_K_V2_PER_CTA +
#elif TILE_N_PER_WARP == 32 || TILE_N_PER_WARP == 64
                       ldsb_idy   * TILE_K_V2_PER_CTA      +
#endif
