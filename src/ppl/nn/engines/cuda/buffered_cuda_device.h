...
public:
    ...
    ppl::common::RetCode Init(int device_id, uint32_t mm_policy, ppl::common::NcclParam* tp_nccl_param,
...
private:
    ...
    std::unique_ptr<ppl::common::CompactAddrManager::VMAllocator> vmr_;
