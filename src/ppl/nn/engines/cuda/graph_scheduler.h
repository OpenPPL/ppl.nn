...
// under the License.
#ifndef _ST_HPC_PPL_NN_ENGINES_CUDA_GRAPH_SCHEDULER_H_
#define _ST_HPC_PPL_NN_ENGINES_CUDA_GRAPH_SCHEDULER_H_

#include "ppl/common/object_pool.h"
#include "ppl/nn/engines/cuda/graph_runner.h"
#include "ppl/nn/runtime/scheduler.h"
#include "ppl/nn/runtime/tensor_impl.h"
#include "ppl/nn/runtime/tensor_sequence.h"

namespace ppl { namespace nn { namespace cuda {
class CudaGraphScheduler final : public Scheduler {
public:
    CudaGraphScheduler();
...
private:
    ppl::common::RetCode ExecForEach(KernelExecContext&,
                                     const std::function<ppl::common::RetCode(KernelImpl*, KernelExecContext*)>&,
                                     Profiler*);
...
private:
    ...
    ppl::nn::cuda::CudaGraphRunner graph_runner_;
};
