...
ppl::common::RetCode SoftplusKernel::DoExecute(KernelExecContext* ctx) {
    ...
    ppl::common::RetCode status = PPLCUDAUnaryZeroSoftplusForwardImp(GetStream(), input->GetShape(), input->GetBufferPtr(),
