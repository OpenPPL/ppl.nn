...
#ifndef _ST_HPC_PPL_NN_ENGINES_CPU_ONNX_SPLIT_TO_SEQUENCE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_CPU_ONNX_SPLIT_TO_SEQUENCE_OP_H_

#include "ppl/nn/runtime/kernel_impl.h"
#include "ppl/nn/engines/cpu/onnx/split_to_sequence_kernel.h"
