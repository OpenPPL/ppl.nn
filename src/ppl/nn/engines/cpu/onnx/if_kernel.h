...
#ifndef _ST_HPC_PPL_NN_ENGINES_CPU_ONNX_IF_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_CPU_ONNX_IF_KERNEL_H_
...
class IfKernel final : public CpuKernelImpl {
public:
    IfKernel(const ir::Node* node) : CpuKernelImpl(node) {}
