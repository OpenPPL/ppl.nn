...
#ifndef _ST_HPC_PPL_NN_ENGINES_CPU_GENERIC_CPU_DEVICE_H_
#define _ST_HPC_PPL_NN_ENGINES_CPU_GENERIC_CPU_DEVICE_H_

#include "ppl/nn/common/device.h"
#include "ppl/nn/engines/cpu/generic_cpu_data_converter.h"
