...
#ifndef _ST_HPC_PPL_NN_ENGINES_CPU_PMX_CONVERTER_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_CPU_PMX_CONVERTER_OP_H_

#include "ppl/nn/runtime/opt_kernel.h"
#include "ppl/nn/engines/cpu/pmx/converter_kernel.h"
