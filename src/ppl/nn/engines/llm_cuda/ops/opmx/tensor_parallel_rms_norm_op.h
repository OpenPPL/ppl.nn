...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_TENSOR_PARALLEL_RMS_NORM_OP_H_
...
class TensorParallelRMSNormOp final : public LlmCudaOptKernel {
public:
    TensorParallelRMSNormOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::TensorParallelRMSNormParam> param_;
};
