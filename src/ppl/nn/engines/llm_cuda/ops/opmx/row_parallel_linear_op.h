...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_ROW_PARALLEL_LINEAR_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_ROW_PARALLEL_LINEAR_OP_H_
...
class RowParallelLinearOp final : public LlmCudaOptKernel {
public:
    RowParallelLinearOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
