...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_PARALLEL_EMBEDDING_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_PARALLEL_EMBEDDING_OP_H_
...
class ParallelEmbeddingOp final : public LlmCudaOptKernel {
public:
    ParallelEmbeddingOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::ParallelEmbeddingParam> param_;
