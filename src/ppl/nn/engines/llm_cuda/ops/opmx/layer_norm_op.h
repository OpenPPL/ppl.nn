...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_LAYER_NORM_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_LAYER_NORM_OP_H_
...
class LayerNormOp final : public LlmCudaOptKernel {
public:
    LayerNormOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::pmx::LayerNormParam> param_;
};
