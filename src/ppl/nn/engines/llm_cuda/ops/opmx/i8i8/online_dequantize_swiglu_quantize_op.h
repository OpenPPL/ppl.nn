...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I8I8_ONLINE_DEQUANTIZE_SWIGLU_QUANTIZE_OP_H_
...
class I8I8OnlineDequantizeSwiGLUQuantizeOp final : public LlmCudaOptKernel {
public:
    I8I8OnlineDequantizeSwiGLUQuantizeOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
