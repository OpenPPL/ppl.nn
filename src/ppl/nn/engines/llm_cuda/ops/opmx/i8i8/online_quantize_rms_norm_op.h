...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I8I8_ONLINE_QUATIZED_RMS_NORM_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I8I8_ONLINE_QUATIZED_RMS_NORM_OP_H_
...
class I8I8OnlineQuantizeRMSNormOp final : public LlmCudaOptKernel {
public:
    I8I8OnlineQuantizeRMSNormOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::pmx::RMSNormParam> param_;
};
