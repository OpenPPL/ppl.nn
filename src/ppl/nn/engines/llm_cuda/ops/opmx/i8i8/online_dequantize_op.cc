...
#include "ppl/nn/engines/llm_cuda/kernels/opmx/i8i8/online_dequantize_kernel.h"
...
ppl::common::RetCode I8I8OnlineDequantizeOp::SerializeData(const ppl::nn::pmx::SerializationContext&, utils::DataStream* ds) const {
    ...
    auto fb_param = opmx::i8i8::CreateOnlineDequantizeParam(builder, param_.bias_term);
    auto fb_op_param = opmx::i8i8::CreateOpParam(builder, opmx::i8i8::OpParamType_OnlineDequantizeParam, fb_param.Union());
