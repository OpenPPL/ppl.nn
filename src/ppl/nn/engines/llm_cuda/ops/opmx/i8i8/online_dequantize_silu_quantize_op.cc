...
#include "online_dequantize_silu_quantize_op.h"

#include "ppl/nn/engines/llm_cuda/kernels/opmx/i8i8/online_dequantize_silu_quantize_kernel.h"
...
RetCode I8I8OnlineDequantizeSiLUQuantizeOp::CommonInit() {
...
RetCode I8I8OnlineDequantizeSiLUQuantizeOp::DoInit(const OptKernelOptions& options) {
    return CommonInit();
}

KernelImpl* I8I8OnlineDequantizeSiLUQuantizeOp::CreateKernelImpl() const {
    return CreateKernelImplWithoutParam<I8I8OnlineDequantizeSiLUQuantizeKernel>();
}

#ifdef PPLNN_ENABLE_PMX_MODEL
ppl::common::RetCode I8I8OnlineDequantizeSiLUQuantizeOp::SerializeData(const ppl::nn::pmx::SerializationContext&, utils::DataStream* ds) const {
    return RC_SUCCESS;
}

ppl::common::RetCode I8I8OnlineDequantizeSiLUQuantizeOp::DeserializeData(const ppl::nn::pmx::DeserializationContext& ctx, const void* base, uint64_t size) {
    return CommonInit();
}
#endif
