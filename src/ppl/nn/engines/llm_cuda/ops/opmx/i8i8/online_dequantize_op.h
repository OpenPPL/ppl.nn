...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I8I8_ONLINE_DEQUANTIZE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I8I8_ONLINE_DEQUANTIZE_OP_H_

#include "ppl/nn/engines/llm_cuda/opt_kernel.h"

namespace ppl { namespace nn { namespace llm { namespace cuda { namespace opmx {

class I8I8OnlineDequantizeOp final : public LlmCudaOptKernel {
public:
    I8I8OnlineDequantizeOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
