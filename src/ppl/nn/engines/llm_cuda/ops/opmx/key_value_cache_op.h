...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_KEY_VALUE_CACHE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_KEY_VALUE_CACHE_OP_H_
...
class KeyValueCacheOp final : public LlmCudaOptKernel {
public:
    KeyValueCacheOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
