...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_PMX_F8F8_COLUMN_PARALLEL_LINEAR_OP_H_
...
class F8F8ColumnParallelLinearOp final : public LlmCudaOptKernel {
public:
    F8F8ColumnParallelLinearOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
