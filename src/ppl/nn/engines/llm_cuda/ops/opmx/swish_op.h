...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_SWISH_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_SWISH_OP_H_
...
class SwishOp final : public LlmCudaOptKernel {
public:
    SwishOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
