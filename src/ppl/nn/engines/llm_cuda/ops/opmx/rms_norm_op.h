...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_RMS_NORM_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_RMS_NORM_OP_H_
...
class RMSNormOp final : public LlmCudaOptKernel {
public:
    RMSNormOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
