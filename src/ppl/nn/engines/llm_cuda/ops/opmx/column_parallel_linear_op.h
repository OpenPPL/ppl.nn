...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_COLUMN_PARALLEL_LINEAR_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_COLUMN_PARALLEL_LINEAR_OP_H_
...
class ColumnParallelLinearOp final : public LlmCudaOptKernel {
public:
    ColumnParallelLinearOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
