...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_POSITION_INDEX_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_POSITION_INDEX_OP_H_

#include "ppl/nn/engines/llm_cuda/opt_kernel.h"

namespace ppl { namespace nn { namespace llm { namespace cuda { namespace opmx {

class DynamicBatchingPositionIndexOp final : public LlmCudaOptKernel {
public:
    DynamicBatchingPositionIndexOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
