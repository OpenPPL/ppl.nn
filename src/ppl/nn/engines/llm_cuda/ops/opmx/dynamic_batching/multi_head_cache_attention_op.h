...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_MULTI_HEAD_CACHE_ATTENTION_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_MULTI_HEAD_CACHE_ATTENTION_OP_H_
...
class DynamicBatchingMultiHeadCacheAttentionOp final : public LlmCudaOptKernel {
public:
    DynamicBatchingMultiHeadCacheAttentionOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::MultiHeadCacheAttentionParam> param_;
};
