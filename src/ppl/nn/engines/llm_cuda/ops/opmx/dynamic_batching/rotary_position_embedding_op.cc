...
#include "ppl/nn/engines/llm_cuda/kernels/opmx/dynamic_batching/rotary_position_embedding_kernel.h"
#include "ppl/nn/oputils/opmx/reshape_rotary_position_embedding.h"
...
RetCode DynamicBatchingRotaryPositionEmbeddingOp::CommonInit() {
    ...
    infer_dims_func_ = [this](InputOutputInfo* info) -> RetCode {
        return ppl::nn::opmx::ReshapeRotaryPositionEmbedding(info, param_.get());
    };
    return RC_SUCCESS;
}
...
#ifdef PPLNN_ENABLE_PMX_MODEL
ppl::common::RetCode DynamicBatchingRotaryPositionEmbeddingOp::SerializeData(const ppl::nn::pmx::SerializationContext& ctx, utils::DataStream* ds) const {
...
ppl::common::RetCode DynamicBatchingRotaryPositionEmbeddingOp::DeserializeData(const ppl::nn::pmx::DeserializationContext& ctx, const void* base, uint64_t size) {
