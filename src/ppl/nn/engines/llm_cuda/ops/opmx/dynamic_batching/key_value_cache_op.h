...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_KEY_VALUE_CACHE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_DYNAMIC_BATCHING_KEY_VALUE_CACHE_OP_H_
...
class DynamicBatchingKeyValueCacheOp final : public LlmCudaOptKernel {
public:
    DynamicBatchingKeyValueCacheOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::KeyValueCacheParam> param_;
};
