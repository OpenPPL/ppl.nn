...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_GEGLU_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_GEGLU_OP_H_
...
class GeGLUOp final : public LlmCudaOptKernel {
public:
    GeGLUOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
