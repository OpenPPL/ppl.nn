...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_MULTI_HEAD_ATTENTION_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_MULTI_HEAD_ATTENTION_OP_H_
...
class MultiHeadAttentionOp final : public LlmCudaOptKernel {
public:
    MultiHeadAttentionOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
