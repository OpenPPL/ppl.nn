...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I4F16_ROW_PARALLEL_LINEAR_OP_H_
...
class I4F16RowParallelLinearOp final : public LlmCudaOptKernel {
public:
    I4F16RowParallelLinearOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
