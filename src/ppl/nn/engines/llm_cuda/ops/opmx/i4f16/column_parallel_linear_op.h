...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I4F16_COLUMN_PARALLEL_LINEAR_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_I4F16_COLUMN_PARALLEL_LINEAR_OP_H_
...
class I4F16ColumnParallelLinearOp final : public LlmCudaOptKernel {
public:
    I4F16ColumnParallelLinearOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::ColumnParallelLinearParam> param_;
