...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_PIXEL_UNSHUFFLE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_PIXEL_UNSHUFFLE_OP_H_
...
class PixelUnshuffleOp final : public LlmCudaOptKernel {
public:
    PixelUnshuffleOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    std::shared_ptr<ppl::nn::opmx::PixelUnshuffleParam> param_;
};
