...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_ROTARY_POSITION_EMBEDDING_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_OPMX_ROTARY_POSITION_EMBEDDING_OP_H_
...
class RotaryPositionEmbeddingOp final : public LlmCudaOptKernel {
public:
    RotaryPositionEmbeddingOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
