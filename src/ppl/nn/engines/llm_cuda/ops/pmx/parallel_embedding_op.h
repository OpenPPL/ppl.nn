...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_PMX_PARALLEL_EMBEDDING_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_PMX_PARALLEL_EMBEDDING_OP_H_
...
private:
    ...
    std::shared_ptr<ppl::nn::pmx::ParallelEmbeddingParam> param_;
