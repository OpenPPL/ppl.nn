...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_PMX_SWIGLU_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_PMX_SWIGLU_OP_H_
...
class SwiGLUOp final : public LlmCudaOptKernel {
public:
    SwiGLUOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
