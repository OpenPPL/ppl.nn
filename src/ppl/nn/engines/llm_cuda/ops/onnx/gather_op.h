...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_GATHER_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_GATHER_OP_H_
...
class GatherOp final : public LlmCudaOptKernel {
public:
    GatherOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
