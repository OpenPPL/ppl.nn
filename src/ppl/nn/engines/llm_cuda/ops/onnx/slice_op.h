...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_SLICE_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_SLICE_OP_H_
...
class SliceOp final : public LlmCudaOptKernel {
public:
    SliceOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
...
private:
    ...
    SliceParam constant_slice_param_;
};
