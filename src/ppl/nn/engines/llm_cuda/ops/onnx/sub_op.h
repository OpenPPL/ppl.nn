...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_SUB_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_SUB_OP_H_

#include "ppl/nn/engines/llm_cuda/opt_kernel.h"

namespace ppl { namespace nn { namespace llm { namespace cuda { namespace onnx {

class SubOp final : public LlmCudaOptKernel {
public:
    SubOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
