...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_ADD_OP_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPS_ONNX_ADD_OP_H_

#include "ppl/nn/engines/llm_cuda/opt_kernel.h"

namespace ppl { namespace nn { namespace llm { namespace cuda { namespace onnx {

class AddOp final : public LlmCudaOptKernel {
public:
    AddOp(const ir::Node* node) : LlmCudaOptKernel(node) {}
