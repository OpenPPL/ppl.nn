...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPT_KERNEL_CREATOR_MANAGER_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_OPT_KERNEL_CREATOR_MANAGER_H_
...
typedef LlmCudaOptKernel* (*OptKernelCreator)(const ir::Node*);
