...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_CAST_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_CAST_KERNEL_H_
...
class CastKernel : public LlmCudaKernel {
public:
    CastKernel(const ir::Node* node) : LlmCudaKernel(node) {}
