...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_SPLIT_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_SPLIT_KERNEL_H_
...
class SplitKernel : public LlmCudaKernel {
public:
    SplitKernel(const ir::Node* node) : LlmCudaKernel(node) {}
