...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_GATHER_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_ONNX_GATHER_KERNEL_H_
...
class GatherKernel : public LlmCudaKernel {
public:
    GatherKernel(const ir::Node* node) : LlmCudaKernel(node) {}
