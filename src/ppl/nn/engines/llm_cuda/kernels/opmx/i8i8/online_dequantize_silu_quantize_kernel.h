...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_I8I8_ONLINE_DEQUANTIZE_SILU_QUANTIZE_KERNEL_H_
...
class I8I8OnlineDequantizeSiLUQuantizeKernel : public LlmCudaKernel {
public:
    I8I8OnlineDequantizeSiLUQuantizeKernel(const ir::Node* node) : LlmCudaKernel(node) {}
