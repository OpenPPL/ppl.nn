...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_LAYER_NORM_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_LAYER_NORM_KERNEL_H_
...
class LayerNormKernel : public LlmCudaKernel {
public:
    LayerNormKernel(const ir::Node* node) : LlmCudaKernel(node) {}
