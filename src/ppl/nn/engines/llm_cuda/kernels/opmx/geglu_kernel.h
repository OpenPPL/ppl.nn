...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_GEGLU_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_GEGLU_KERNEL_H_
...
class GeGLUKernel : public LlmCudaKernel {
public:
    GeGLUKernel(const ir::Node* node) : LlmCudaKernel(node) {}
