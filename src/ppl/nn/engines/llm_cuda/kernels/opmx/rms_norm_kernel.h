...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_RMS_NORM_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_RMS_NORM_KERNEL_H_
...
class RMSNormKernel : public LlmCudaKernel {
public:
    RMSNormKernel(const ir::Node* node) : LlmCudaKernel(node) {}
