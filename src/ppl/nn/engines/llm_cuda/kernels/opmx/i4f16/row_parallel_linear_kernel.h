...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_I4F16_ROW_PARALLEL_LINEAR_KERNEL_H_
...
class I4F16RowParallelLinearKernel : public LlmCudaKernel {
public:
    I4F16RowParallelLinearKernel(const ir::Node* node) : LlmCudaKernel(node) {}
