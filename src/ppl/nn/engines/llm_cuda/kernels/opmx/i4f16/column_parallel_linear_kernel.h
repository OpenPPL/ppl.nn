...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_I4F16_COLUMN_PARALLEL_LINEAR_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_I4F16_COLUMN_PARALLEL_LINEAR_KERNEL_H_
...
class I4F16ColumnParallelLinearKernel : public LlmCudaKernel {
public:
    I4F16ColumnParallelLinearKernel(const ir::Node* node) : LlmCudaKernel(node) {}
