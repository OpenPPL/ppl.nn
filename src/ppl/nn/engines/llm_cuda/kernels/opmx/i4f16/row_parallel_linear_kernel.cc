...
ppl::common::RetCode I4F16RowParallelLinearKernel::DoExecute(KernelExecContext* ctx) {
    ...
    if (use_fp16_gemm) {
        ...
        const int64_t tmp_buffer_size = dequant_weight_buffer_size;
        ...
        dequant_weight_buffer = tmp_buffer_desc.addr;
        ...
        return ppl::kernel::llm::cuda::pmx::i4f16::row_parallel_linear(
            GetStream(),
