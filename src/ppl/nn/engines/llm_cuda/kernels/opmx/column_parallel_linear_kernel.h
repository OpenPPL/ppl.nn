...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_COLUMN_PARALLEL_LINEAR_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_OPMX_COLUMN_PARALLEL_LINEAR_KERNEL_H_
...
class ColumnParallelLinearKernel : public LlmCudaKernel {
public:
    ColumnParallelLinearKernel(const ir::Node* node) : LlmCudaKernel(node) {}
