...
#ifndef _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_PMX_SWIGLU_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_LLM_CUDA_KERNELS_PMX_SWIGLU_KERNEL_H_
...
class SwiGLUKernel : public LlmCudaKernel {
public:
