...
#ifndef _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_ONNX_GATHER_ND_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_ONNX_GATHER_ND_KERNEL_H_
...
class GatherNdKernel : public X86Kernel {
public:
