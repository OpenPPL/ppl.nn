...
#ifndef _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_ONNX_CONV1D_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_ONNX_CONV1D_KERNEL_H_
...
class Conv1dKernel : public X86Kernel {
public:
    Conv1dKernel(const ir::Node* node) : X86Kernel(node) {}
    ~Conv1dKernel() {
        if (executor_)
            delete executor_;
