...
#ifndef _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_MMCV_MMCV_ROIALIGN_KERNEL_H_
#define _ST_HPC_PPL_NN_ENGINES_X86_KERNELS_MMCV_MMCV_ROIALIGN_KERNEL_H_
...
class MMCVROIAlignKernel : public X86Kernel {
public:
