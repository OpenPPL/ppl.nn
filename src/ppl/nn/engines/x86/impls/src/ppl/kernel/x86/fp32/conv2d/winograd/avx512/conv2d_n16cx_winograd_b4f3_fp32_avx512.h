...
public:
    ...
    conv2d_n16cx_winograd_b4f3_fp32_avx512_executor(const conv2d_param *conv_param, const float *cvt_filter, const float *bias)
...
public:
    ...
    conv2d_n16cx_winograd_b4f3_fp32_avx512_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
