...
#ifndef __ST_PPL_KERNEL_X86_FP32_CONV_TRANSPOSE_COL2IM2D_FP32_AVX_H_
#define __ST_PPL_KERNEL_X86_FP32_CONV_TRANSPOSE_COL2IM2D_FP32_AVX_H_
...
static void col2im2d_ndarray_fp32_avx(
    const float *col,
    const float *bias,
    const int64_t col_h,
    const int64_t col_w,
