...
"9:\n" // label_ic
        ...
        ".if HW_LEN > 0\n vfmadd231ps ((0 + 0 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm0\n .endif\n"
        ".if HW_LEN > 1\n vfmadd231ps ((0 + 1 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm1\n .endif\n"
        ".if HW_LEN > 2\n vfmadd231ps ((0 + 2 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm2\n .endif\n"
        ".if HW_LEN > 3\n vfmadd231ps ((0 + 3 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm3\n .endif\n"
        ".if HW_LEN > 4\n vfmadd231ps ((0 + 4 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm4\n .endif\n"
        ".if HW_LEN > 5\n vfmadd231ps ((0 + 5 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm5\n .endif\n"
        ".if HW_LEN > 6\n vfmadd231ps ((0 + 6 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm6\n .endif\n"
        ".if HW_LEN > 7\n vfmadd231ps ((0 + 7 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm7\n .endif\n"
        ".if HW_LEN > 8\n vfmadd231ps ((0 + 8 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm8\n .endif\n"
        ".if HW_LEN > 9\n vfmadd231ps ((0 + 9 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm9\n .endif\n"
        ".if HW_LEN > 10\n vfmadd231ps ((0 + 10 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm10\n .endif\n"
        ".if HW_LEN > 11\n vfmadd231ps ((0 + 11 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm11\n .endif\n"
        ".if HW_LEN > 12\n vfmadd231ps ((0 + 12 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm12\n .endif\n"
        ".if HW_LEN > 13\n vfmadd231ps ((0 + 13 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm13\n .endif\n"
        ".if HW_LEN > 14\n vfmadd231ps ((0 + 14 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm14\n .endif\n"
        ".if HW_LEN > 15\n vfmadd231ps ((0 + 15 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm15\n .endif\n"
        ".if HW_LEN > 16\n vfmadd231ps ((0 + 16 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm16\n .endif\n"
        ".if HW_LEN > 17\n vfmadd231ps ((0 + 17 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm17\n .endif\n"
        ".if HW_LEN > 18\n vfmadd231ps ((0 + 18 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm18\n .endif\n"
        ".if HW_LEN > 19\n vfmadd231ps ((0 + 19 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm19\n .endif\n"
        ".if HW_LEN > 20\n vfmadd231ps ((0 + 20 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm20\n .endif\n"
        ".if HW_LEN > 21\n vfmadd231ps ((0 + 21 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm21\n .endif\n"
        ".if HW_LEN > 22\n vfmadd231ps ((0 + 22 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm22\n .endif\n"
        ".if HW_LEN > 23\n vfmadd231ps ((0 + 23 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm23\n .endif\n"
        ".if HW_LEN > 24\n vfmadd231ps ((0 + 24 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm24\n .endif\n"
        ".if HW_LEN > 25\n vfmadd231ps ((0 + 25 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm25\n .endif\n"
        ".if HW_LEN > 26\n vfmadd231ps ((0 + 26 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm26\n .endif\n"
        ".if HW_LEN > 27\n vfmadd231ps ((0 + 27 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm27\n .endif\n"
        ".if HW_LEN > 28\n vfmadd231ps ((0 + 28 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm28\n .endif\n"
        ".if HW_LEN > 29\n vfmadd231ps ((0 + 29 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm29\n .endif\n"
        ".if HW_LEN > 30\n vfmadd231ps ((0 + 30 * CH_DT_BLK) * D_BYTES)(%%rcx)%{1to16}, %%zmm31, %%zmm30\n .endif\n"
        "lea D_BYTES(%%rcx), %%rcx\n"
        "sub $1, %%r9\n"
        "cmp $0, %%r9\n"
        "jne 9b\n" // label_ic
