...
#ifndef __ST_PPL_KERNEL_X86_FP32_CONV2D_WINOGRAD_B4F3_FMA_CONV2D_N16CX_WINOGRAD_B4F3_FP32_FMA_H_
#define __ST_PPL_KERNEL_X86_FP32_CONV2D_WINOGRAD_B4F3_FMA_CONV2D_N16CX_WINOGRAD_B4F3_FP32_FMA_H_
...
// forward declare;
class conv2d_n16cx_winograd_b4f3_fp32_fma_manager;

class conv2d_n16cx_winograd_b4f3_fp32_fma_executor final : public conv2d_fp32_executor {
public:
    conv2d_n16cx_winograd_b4f3_fp32_fma_executor() {}
    conv2d_n16cx_winograd_b4f3_fp32_fma_executor(const conv2d_fp32_param *conv_param, const float *cvt_filter, const float *bias)
...
private:
    ...
    friend conv2d_n16cx_winograd_b4f3_fp32_fma_manager;
};

class conv2d_n16cx_winograd_b4f3_fp32_fma_manager final : public conv2d_fp32_manager {
public:
    conv2d_n16cx_winograd_b4f3_fp32_fma_manager() {}
    conv2d_n16cx_winograd_b4f3_fp32_fma_manager(const conv2d_fp32_param &param, ppl::common::Allocator *allocator)
