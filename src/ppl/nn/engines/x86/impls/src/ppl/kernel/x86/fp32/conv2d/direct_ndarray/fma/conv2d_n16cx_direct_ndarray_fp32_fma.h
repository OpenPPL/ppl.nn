...
public:
    ...
    conv2d_n16cx_direct_ndarray_fp32_fma_executor(const conv2d_param *conv_param, const float *cvt_filter, const float *bias)
...
public:
    ...
    conv2d_n16cx_direct_ndarray_fp32_fma_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
