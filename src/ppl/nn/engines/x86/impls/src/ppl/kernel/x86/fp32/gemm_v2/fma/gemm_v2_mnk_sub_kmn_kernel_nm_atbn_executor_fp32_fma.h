...
#ifndef __ST_PPL_KERNEL_X86_FP32_GEMM_V2_GEMM_V2_MNK_SUB_KMN_KERNEL_NM_ATBN_EXECUTOR_FP32_FMA_H_
#define __ST_PPL_KERNEL_X86_FP32_GEMM_V2_GEMM_V2_MNK_SUB_KMN_KERNEL_NM_ATBN_EXECUTOR_FP32_FMA_H_
...
class gemm_v2_mnk_sub_kmn_kernel_nm_atbn_executor_fp32_fma : public gemm_v2_executor_fp32 {
public:
    gemm_v2_mnk_sub_kmn_kernel_nm_atbn_executor_fp32_fma()
    {
        // default internal param
        blk_partition_.m_blk_len = 144; // 242 KB used in L2/L3
        blk_partition_.n_blk_len = 160;
        blk_partition_.k_blk_len = 128;

        blk_partition_.m_sub_blk_len = 18; // 27.25 KB used in L1
        blk_partition_.n_sub_blk_len = 32;
        blk_partition_.k_sub_blk_len = 128;

        blk_partition_.m_kernel_blk_len = 6; // only support 6x16 kernel now
        blk_partition_.n_kernel_blk_len = 16;
    }
    virtual ~gemm_v2_mnk_sub_kmn_kernel_nm_atbn_executor_fp32_fma() {}
...
#endif // !__ST_PPL_KERNEL_X86_FP32_GEMM_V2_GEMM_V2_MNK_SUB_KMN_KERNEL_NM_ATBN_EXECUTOR_FP32_FMA_H_