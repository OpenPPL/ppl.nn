...
#ifndef __ST_PPL_KERENL_X86_FP32_CONV2D_WINOGRAD_B6F3_SSE_CONV2D_WINOGRAD_B6F3_FP32_SSE_H_
#define __ST_PPL_KERENL_X86_FP32_CONV2D_WINOGRAD_B6F3_SSE_CONV2D_WINOGRAD_B6F3_FP32_SSE_H_
...
class conv2d_winograd_b6f3_fp32_sse_manager;

class conv2d_winograd_b6f3_fp32_sse_executor final : public conv2d_fp32_executor {
public:
    conv2d_winograd_b6f3_fp32_sse_executor() {}
    conv2d_winograd_b6f3_fp32_sse_executor(const conv2d_fp32_param *conv_param, const float *cvt_filter, const float *bias)
...
private:
    ...
    friend conv2d_winograd_b6f3_fp32_sse_manager;
};

class conv2d_winograd_b6f3_fp32_sse_manager final : public conv2d_fp32_manager {
public:
    conv2d_winograd_b6f3_fp32_sse_manager() {}
    conv2d_winograd_b6f3_fp32_sse_manager(const conv2d_fp32_param &param, ppl::common::Allocator *allocator)
