...
#define GEMM_DIRECT_O8_KERNEL_TABLE_BLK(NT_STORE) \
    {\
        conv2d_n8cx_gemm_direct_fp32_sse_blk1x3_kernel<NT_STORE, 1 * CH_DT_BLK(), 1>,\
        conv2d_n8cx_gemm_direct_fp32_sse_blk1x3_kernel<NT_STORE, 1 * CH_DT_BLK(), 2>,\
        conv2d_n8cx_gemm_direct_fp32_sse_blk1x3_kernel<NT_STORE, 1 * CH_DT_BLK(), 3>,\
    }

#define GEMM_DIRECT_O16_KERNEL_TABLE_BLK(NT_STORE) \
    {\
        conv2d_n8cx_gemm_direct_fp32_sse_blk1x3_kernel<NT_STORE, 2 * CH_DT_BLK(), 1>,\
        conv2d_n8cx_gemm_direct_fp32_sse_blk1x3_kernel<NT_STORE, 2 * CH_DT_BLK(), 2>,\
...
{
    GEMM_DIRECT_O8_KERNEL_TABLE_BLK(false),
    GEMM_DIRECT_O8_KERNEL_TABLE_BLK(true),
};
