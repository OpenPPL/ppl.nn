...
class conv2d_n16cx_direct_ndarray_kernel_fp32_fma {
public:
    ...
    struct param_def {
        ...
        static const int64_t KH_START_IDX = 10;
        static const int64_t KH_END_IDX = 11;
        static const int64_t KW_START_IDX = 12;
        static const int64_t KW_END_IDX = 13;
        static const int64_t KH_IDX = 14;
        static const int64_t KW_IDX = 15;
        static const int64_t SW_IDX = 16;
