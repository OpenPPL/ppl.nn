...
#ifndef __ST_PPL_KERNEL_X86_FP32_CONV2D_DIRECT_AVX512_CONV2D_N16CX_DIRECT_BLK1X6_KERNEL_FP32_AVX512_H_
#define __ST_PPL_KERNEL_X86_FP32_CONV2D_DIRECT_AVX512_CONV2D_N16CX_DIRECT_BLK1X6_KERNEL_FP32_AVX512_H_
...
void conv2d_n16cx_direct_fp32_avx512_blk1x6_kernel(
    const int64_t *shar_param,
    int64_t *priv_param)
{
#define IC_COMPUTE_STEP(IC) do {\
    if (oc_len > 0 * CH_DT_BLK()) zmm24 = _mm512_loadu_ps(icb_flt_o16 + 0 * flt_ocb_stride + (IC) * CH_DT_BLK());\
    if (oc_len > 1 * CH_DT_BLK()) zmm25 = _mm512_loadu_ps(icb_flt_o16 + 1 * flt_ocb_stride + (IC) * CH_DT_BLK());\
    if (oc_len > 2 * CH_DT_BLK()) zmm26 = _mm512_loadu_ps(icb_flt_o48 + 0 * flt_ocb_stride + (IC) * CH_DT_BLK());\
    if (oc_len > 3 * CH_DT_BLK()) zmm27 = _mm512_loadu_ps(icb_flt_o48 + 1 * flt_ocb_stride + (IC) * CH_DT_BLK());\
    if (w_len > 0) {\
        zmm30 = _mm512_set1_ps(k_src[(IC) + 0 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm0 = _mm512_fmadd_ps(zmm24, zmm30, zmm0);\
        if (oc_len > 1 * CH_DT_BLK()) zmm6 = _mm512_fmadd_ps(zmm25, zmm30, zmm6);\
        if (oc_len > 2 * CH_DT_BLK()) zmm12 = _mm512_fmadd_ps(zmm26, zmm30, zmm12);\
        if (oc_len > 3 * CH_DT_BLK()) zmm18 = _mm512_fmadd_ps(zmm27, zmm30, zmm18);\
    }\
    if (w_len > 1) {\
        zmm31 = _mm512_set1_ps(k_src[(IC) + 1 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm1 = _mm512_fmadd_ps(zmm24, zmm31, zmm1);\
        if (oc_len > 1 * CH_DT_BLK()) zmm7 = _mm512_fmadd_ps(zmm25, zmm31, zmm7);\
        if (oc_len > 2 * CH_DT_BLK()) zmm13 = _mm512_fmadd_ps(zmm26, zmm31, zmm13);\
        if (oc_len > 3 * CH_DT_BLK()) zmm19 = _mm512_fmadd_ps(zmm27, zmm31, zmm19);\
    }\
    if (w_len > 2) {\
        zmm30 = _mm512_set1_ps(k_src[(IC) + 2 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm2 = _mm512_fmadd_ps(zmm24, zmm30, zmm2);\
        if (oc_len > 1 * CH_DT_BLK()) zmm8 = _mm512_fmadd_ps(zmm25, zmm30, zmm8);\
        if (oc_len > 2 * CH_DT_BLK()) zmm14 = _mm512_fmadd_ps(zmm26, zmm30, zmm14);\
        if (oc_len > 3 * CH_DT_BLK()) zmm20 = _mm512_fmadd_ps(zmm27, zmm30, zmm20);\
    }\
    if (w_len > 3) {\
        zmm31 = _mm512_set1_ps(k_src[(IC) + 3 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm3 = _mm512_fmadd_ps(zmm24, zmm31, zmm3);\
        if (oc_len > 1 * CH_DT_BLK()) zmm9 = _mm512_fmadd_ps(zmm25, zmm31, zmm9);\
        if (oc_len > 2 * CH_DT_BLK()) zmm15 = _mm512_fmadd_ps(zmm26, zmm31, zmm15);\
        if (oc_len > 3 * CH_DT_BLK()) zmm21 = _mm512_fmadd_ps(zmm27, zmm31, zmm21);\
    }\
    if (w_len > 4) {\
        zmm30 = _mm512_set1_ps(k_src[(IC) + 4 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm4 = _mm512_fmadd_ps(zmm24, zmm30, zmm4);\
        if (oc_len > 1 * CH_DT_BLK()) zmm10 = _mm512_fmadd_ps(zmm25, zmm30, zmm10);\
        if (oc_len > 2 * CH_DT_BLK()) zmm16 = _mm512_fmadd_ps(zmm26, zmm30, zmm16);\
        if (oc_len > 3 * CH_DT_BLK()) zmm22 = _mm512_fmadd_ps(zmm27, zmm30, zmm22);\
    }\
    if (w_len > 5) {\
        zmm31 = _mm512_set1_ps(k_src[(IC) + 5 * src_sw_stride]);\
        if (oc_len > 0 * CH_DT_BLK()) zmm5 = _mm512_fmadd_ps(zmm24, zmm31, zmm5);\
        if (oc_len > 1 * CH_DT_BLK()) zmm11 = _mm512_fmadd_ps(zmm25, zmm31, zmm11);\
        if (oc_len > 2 * CH_DT_BLK()) zmm17 = _mm512_fmadd_ps(zmm26, zmm31, zmm17);\
        if (oc_len > 3 * CH_DT_BLK()) zmm23 = _mm512_fmadd_ps(zmm27, zmm31, zmm23);\
    }\
} while (0)

#define IC_PREFETCH_STEP(IC)  do {\
    if (oc_len > 3 * CH_DT_BLK() && w_len > 3) {\
        ...
        if (oc_len > 3 * CH_DT_BLK()) _mm_prefetch((const char*)icb_flt_o48 + 1 * flt_ocb_stride + (IC) * CH_DT_BLK() + CH_DT_BLK() * CH_DT_BLK(), _MM_HINT_T0);\
    }\
} while (0)
    ...
    do {
        ...
        if (kernel_flags & KERNEL_FLAG_LD_BIAS()) {
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                if (w_len > 0) zmm6  = _mm512_loadu_ps(bias + 1 * CH_DT_BLK());
                if (w_len > 1) zmm7  = zmm6;
                if (w_len > 2) zmm8  = zmm6;
                if (w_len > 3) zmm9  = zmm6;
                if (w_len > 4) zmm10 = zmm6;
                if (w_len > 5) zmm11 = zmm6;
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                if (w_len > 0) zmm12 = _mm512_loadu_ps(bias + 2 * CH_DT_BLK());
                if (w_len > 1) zmm13 = zmm12;
                if (w_len > 2) zmm14 = zmm12;
                if (w_len > 3) zmm15 = zmm12;
                if (w_len > 4) zmm16 = zmm12;
                if (w_len > 5) zmm17 = zmm12;
            }
            if (oc_len > 3 * CH_DT_BLK()) {
                if (w_len > 0) zmm18 = _mm512_loadu_ps(bias + 3 * CH_DT_BLK());
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                ...
                if (w_len > 0) zmm6  = _mm512_loadu_ps(l_his + 0 * CH_DT_BLK());
                if (w_len > 1) zmm7  = _mm512_loadu_ps(l_his + 1 * CH_DT_BLK());
                if (w_len > 2) zmm8  = _mm512_loadu_ps(l_his + 2 * CH_DT_BLK());
                if (w_len > 3) zmm9  = _mm512_loadu_ps(l_his + 3 * CH_DT_BLK());
                if (w_len > 4) zmm10 = _mm512_loadu_ps(l_his + 4 * CH_DT_BLK());
                if (w_len > 5) zmm11 = _mm512_loadu_ps(l_his + 5 * CH_DT_BLK());
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                l_his += his_ocb_stride;
                if (w_len > 0) zmm12 = _mm512_loadu_ps(l_his + 0 * CH_DT_BLK());
                if (w_len > 1) zmm13 = _mm512_loadu_ps(l_his + 1 * CH_DT_BLK());
                if (w_len > 2) zmm14 = _mm512_loadu_ps(l_his + 2 * CH_DT_BLK());
                if (w_len > 3) zmm15 = _mm512_loadu_ps(l_his + 3 * CH_DT_BLK());
                if (w_len > 4) zmm16 = _mm512_loadu_ps(l_his + 4 * CH_DT_BLK());
                if (w_len > 5) zmm17 = _mm512_loadu_ps(l_his + 5 * CH_DT_BLK());
            }
            if (oc_len > 3 * CH_DT_BLK()) {
                l_his += his_ocb_stride;
        ...
        if (kernel_flags & KERNEL_FLAG_AD_BIAS()) {
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                ...
                if (w_len > 0) zmm6  = _mm512_add_ps(zmm31, zmm6);
                if (w_len > 1) zmm7  = _mm512_add_ps(zmm31, zmm7);
                if (w_len > 2) zmm8  = _mm512_add_ps(zmm31, zmm8);
                if (w_len > 3) zmm9  = _mm512_add_ps(zmm31, zmm9);
                if (w_len > 4) zmm10 = _mm512_add_ps(zmm31, zmm10);
                if (w_len > 5) zmm11 = _mm512_add_ps(zmm31, zmm11);
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                zmm30 = _mm512_loadu_ps(bias + 2 * CH_DT_BLK());
                if (w_len > 0) zmm12 = _mm512_add_ps(zmm30, zmm12);
                if (w_len > 1) zmm13 = _mm512_add_ps(zmm30, zmm13);
                if (w_len > 2) zmm14 = _mm512_add_ps(zmm30, zmm14);
                if (w_len > 3) zmm15 = _mm512_add_ps(zmm30, zmm15);
                if (w_len > 4) zmm16 = _mm512_add_ps(zmm30, zmm16);
                if (w_len > 5) zmm17 = _mm512_add_ps(zmm30, zmm17);
            }
            if (oc_len > 3 * CH_DT_BLK()) {
                zmm31 = _mm512_loadu_ps(bias + 3 * CH_DT_BLK());
                if (w_len > 0) zmm18 = _mm512_add_ps(zmm31, zmm18);
                if (w_len > 1) zmm19 = _mm512_add_ps(zmm31, zmm19);
                if (w_len > 2) zmm20 = _mm512_add_ps(zmm31, zmm20);
                if (w_len > 3) zmm21 = _mm512_add_ps(zmm31, zmm21);
                if (w_len > 4) zmm22 = _mm512_add_ps(zmm31, zmm22);
                if (w_len > 5) zmm23 = _mm512_add_ps(zmm31, zmm23);
            }
        }
        ...
        if (kernel_flags & (KERNEL_FLAG_RELU() | KERNEL_FLAG_RELU6())) {
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                if (w_len > 0) zmm6  = _mm512_max_ps(zmm6, zmm30);
                if (w_len > 1) zmm7  = _mm512_max_ps(zmm7, zmm30);
                if (w_len > 2) zmm8  = _mm512_max_ps(zmm8, zmm30);
                if (w_len > 3) zmm9  = _mm512_max_ps(zmm9, zmm30);
                if (w_len > 4) zmm10 = _mm512_max_ps(zmm10, zmm30);
                if (w_len > 5) zmm11 = _mm512_max_ps(zmm11, zmm30);
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                if (w_len > 0) zmm12 = _mm512_max_ps(zmm12, zmm30);
                if (w_len > 1) zmm13 = _mm512_max_ps(zmm13, zmm30);
                if (w_len > 2) zmm14 = _mm512_max_ps(zmm14, zmm30);
                if (w_len > 3) zmm15 = _mm512_max_ps(zmm15, zmm30);
                if (w_len > 4) zmm16 = _mm512_max_ps(zmm16, zmm30);
                if (w_len > 5) zmm17 = _mm512_max_ps(zmm17, zmm30);
            }
            if (oc_len > 3 * CH_DT_BLK()) {
        ...
        if (kernel_flags & KERNEL_FLAG_RELU6()) {
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                if (w_len > 0) zmm6  = _mm512_min_ps(zmm6, zmm31);
                if (w_len > 1) zmm7  = _mm512_min_ps(zmm7, zmm31);
                if (w_len > 2) zmm8  = _mm512_min_ps(zmm8, zmm31);
                if (w_len > 3) zmm9  = _mm512_min_ps(zmm9, zmm31);
                if (w_len > 4) zmm10 = _mm512_min_ps(zmm10, zmm31);
                if (w_len > 5) zmm11 = _mm512_min_ps(zmm11, zmm31);
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                if (w_len > 0) zmm12 = _mm512_min_ps(zmm12, zmm31);
                if (w_len > 1) zmm13 = _mm512_min_ps(zmm13, zmm31);
                if (w_len > 2) zmm14 = _mm512_min_ps(zmm14, zmm31);
                if (w_len > 3) zmm15 = _mm512_min_ps(zmm15, zmm31);
                if (w_len > 4) zmm16 = _mm512_min_ps(zmm16, zmm31);
                if (w_len > 5) zmm17 = _mm512_min_ps(zmm17, zmm31);
            }
            if (oc_len > 3 * CH_DT_BLK()) {
        ...
        if (nt_store) {
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                ...
                if (w_len > 0) _mm512_stream_ps(l_dst + 0 * CH_DT_BLK(), zmm6);
                if (w_len > 1) _mm512_stream_ps(l_dst + 1 * CH_DT_BLK(), zmm7);
                if (w_len > 2) _mm512_stream_ps(l_dst + 2 * CH_DT_BLK(), zmm8);
                if (w_len > 3) _mm512_stream_ps(l_dst + 3 * CH_DT_BLK(), zmm9);
                if (w_len > 4) _mm512_stream_ps(l_dst + 4 * CH_DT_BLK(), zmm10);
                if (w_len > 5) _mm512_stream_ps(l_dst + 5 * CH_DT_BLK(), zmm11);
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                l_dst += dst_ocb_stride;
                if (w_len > 0) _mm512_stream_ps(l_dst + 0 * CH_DT_BLK(), zmm12);
                if (w_len > 1) _mm512_stream_ps(l_dst + 1 * CH_DT_BLK(), zmm13);
                if (w_len > 2) _mm512_stream_ps(l_dst + 2 * CH_DT_BLK(), zmm14);
                if (w_len > 3) _mm512_stream_ps(l_dst + 3 * CH_DT_BLK(), zmm15);
                if (w_len > 4) _mm512_stream_ps(l_dst + 4 * CH_DT_BLK(), zmm16);
                if (w_len > 5) _mm512_stream_ps(l_dst + 5 * CH_DT_BLK(), zmm17);
            }
            if (oc_len > 3 * CH_DT_BLK()) {
                l_dst += dst_ocb_stride;
            ...
            if (oc_len > 1 * CH_DT_BLK()) {
                l_dst += dst_ocb_stride;
                if (w_len > 0) _mm512_storeu_ps(l_dst + 0 * CH_DT_BLK(), zmm6);
                if (w_len > 1) _mm512_storeu_ps(l_dst + 1 * CH_DT_BLK(), zmm7);
                if (w_len > 2) _mm512_storeu_ps(l_dst + 2 * CH_DT_BLK(), zmm8);
                if (w_len > 3) _mm512_storeu_ps(l_dst + 3 * CH_DT_BLK(), zmm9);
                if (w_len > 4) _mm512_storeu_ps(l_dst + 4 * CH_DT_BLK(), zmm10);
                if (w_len > 5) _mm512_storeu_ps(l_dst + 5 * CH_DT_BLK(), zmm11);
            }
            if (oc_len > 2 * CH_DT_BLK()) {
                l_dst += dst_ocb_stride;
                if (w_len > 0) _mm512_storeu_ps(l_dst + 0 * CH_DT_BLK(), zmm12);
                if (w_len > 1) _mm512_storeu_ps(l_dst + 1 * CH_DT_BLK(), zmm13);
                if (w_len > 2) _mm512_storeu_ps(l_dst + 2 * CH_DT_BLK(), zmm14);
                if (w_len > 3) _mm512_storeu_ps(l_dst + 3 * CH_DT_BLK(), zmm15);
                if (w_len > 4) _mm512_storeu_ps(l_dst + 4 * CH_DT_BLK(), zmm16);
                if (w_len > 5) _mm512_storeu_ps(l_dst + 5 * CH_DT_BLK(), zmm17);
            }
            if (oc_len > 3 * CH_DT_BLK()) {
                l_dst += dst_ocb_stride;
