...
#ifndef __ST_PPL_KERNEL_X86_FP32_PD_CONV2D_FMA_PD_CONV2D_N16CX_DEPTHWISE_KERNEL_FP32_FMA_H_
#define __ST_PPL_KERNEL_X86_FP32_PD_CONV2D_FMA_PD_CONV2D_N16CX_DEPTHWISE_KERNEL_FP32_FMA_H_
...
class pd_conv2d_n16cx_depthwise_kernel_fp32_fma {
public:
    ...
    pd_conv2d_n16cx_depthwise_kernel_fp32_fma(int64_t *param) : param_(param) { }
