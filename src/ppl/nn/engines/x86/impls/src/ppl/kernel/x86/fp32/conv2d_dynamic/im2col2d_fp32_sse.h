...
#ifndef __ST_PPL_KERNEL_X86_FP32_CONV_TRANSPOSE_IM2COL2D_FP32_SSE_H_
#define __ST_PPL_KERNEL_X86_FP32_CONV_TRANSPOSE_IM2COL2D_FP32_SSE_H_
...
static void im2col2d_ndarray_fp32_sse(
    const float *img,
