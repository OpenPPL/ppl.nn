...
#ifndef __ST_PPL_KERNEL_X86_FP32_CONV2D_WINOGRAD_B2F5S2_AVX512_CONV2D_N16CX_WINOGRAD_B2F5S2_FP32_AVX512_H_
#define __ST_PPL_KERNEL_X86_FP32_CONV2D_WINOGRAD_B2F5S2_AVX512_CONV2D_N16CX_WINOGRAD_B2F5S2_FP32_AVX512_H_
...
class conv2d_n16cx_winograd_b2f5s2_fp32_avx512_manager;

class conv2d_n16cx_winograd_b2f5s2_fp32_avx512_executor final : public conv2d_fp32_executor {
public:
    conv2d_n16cx_winograd_b2f5s2_fp32_avx512_executor() {}
    conv2d_n16cx_winograd_b2f5s2_fp32_avx512_executor(const conv2d_param *conv_param, const float *cvt_filter, const float *bias)
...
private:
    ...
    friend conv2d_n16cx_winograd_b2f5s2_fp32_avx512_manager;        
};

class conv2d_n16cx_winograd_b2f5s2_fp32_avx512_manager final : public conv2d_fp32_manager {
public:
    conv2d_n16cx_winograd_b2f5s2_fp32_avx512_manager() {}
    conv2d_n16cx_winograd_b2f5s2_fp32_avx512_manager(const conv2d_param &param, ppl::common::Allocator *allocator)
