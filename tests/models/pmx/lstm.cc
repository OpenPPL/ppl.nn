...
TEST_F(PmxTest, test_lstm) {
    ...
    lstm_param1.activations = {ppl::nn::common::LSTMParam::ACT_ELU};
    lstm_param1.clip = 0.34;
    lstm_param1.direction = ppl::nn::common::LSTMParam::DIR_REVERSE;
    ...
    std::vector<ppl::nn::common::LSTMParam::activation_t> activations = lstm_param3.activations;
    float clip = lstm_param3.clip;
    ppl::nn::common::LSTMParam::direction_t direction = lstm_param3.direction;
    ...
    EXPECT_EQ(ppl::nn::common::LSTMParam::ACT_ELU, activations[0]);
    EXPECT_FLOAT_EQ(0.34, clip);
    EXPECT_EQ(ppl::nn::common::LSTMParam::DIR_REVERSE, direction);
