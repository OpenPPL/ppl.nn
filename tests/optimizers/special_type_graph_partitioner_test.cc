...
class TestSpecialTypeGraphPartioner : public testing::Test {
protected:
    void SetUp() override {
...
TEST_F(TestSpecialTypeGraphPartioner, partitioned_by_engine) {
...
TEST_F(TestSpecialTypeGraphPartioner, partition_root_node) {
...
TEST_F(TestSpecialTypeGraphPartioner, partition_by_types) {
    vector<unique_ptr<EngineImpl>> engines;
