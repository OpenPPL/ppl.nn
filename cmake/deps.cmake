...
if(NOT PPLNN_DEP_HPCC_VERSION)
    set(PPLNN_DEP_HPCC_VERSION a4c07a0e74e03ce6662c5d440d3017b157b708b1)
endif()
...
if(NOT PPLNN_DEP_PPLCOMMON_VERSION)
    set(PPLNN_DEP_PPLCOMMON_VERSION 1288fd595c79d6c5afb7845a9e3204693f6770aa)
endif()
...
if(PPLNN_USE_X86_64 OR PPLNN_USE_AARCH64 OR PPLNN_USE_ARMV7 OR PPLNN_USE_RISCV64)
    if(NOT PPLNN_DEP_PPLCPUKERNEL_VERSION)
        set(PPLNN_DEP_PPLCPUKERNEL_VERSION f12d45197f8efecc32b05cf594f2adb3376cd8f2)
    endif()
...
if(PPLNN_USE_CUDA)
    if(NOT PPLNN_DEP_PPLCUDAKERNEL_VERSION)
        set(PPLNN_DEP_PPLCUDAKERNEL_VERSION 3df25d16f5ea0153159fa2f04c6ad732060839d3)
    endif()
...
if(NOT PPLNN_DEP_PPL_LLM_KERNEL_CUDA_VERSION)
    set(PPLNN_DEP_PPL_LLM_KERNEL_CUDA_VERSION 1f109e68018e5c4fa74d215b4d14d59c6d773b25)
endif()
