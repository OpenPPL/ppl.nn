...
#ifndef _ST_HPC_PPL_NN_PYTHON_ONNX_PY_RUNTIME_BUILDER_H_
#define _ST_HPC_PPL_NN_PYTHON_ONNX_PY_RUNTIME_BUILDER_H_
...
struct PyRuntimeBuilder final {
    PyRuntimeBuilder(ppl::nn::onnx::RuntimeBuilder* b) : ptr(b) {}
    ...
    std::unique_ptr<ppl::nn::onnx::RuntimeBuilder> ptr;
