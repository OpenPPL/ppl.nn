...
void RegisterOnnxRuntimeBuilder(const shared_ptr<LuaState>& lstate, const shared_ptr<LuaTable>& lmodule,
    ...
    auto lclass = lstate->CreateClass<LuaOnnxRuntimeBuilder>()
        .DefMember("InitFromFile",
                   [](LuaOnnxRuntimeBuilder* lbuilder, const char* model_file, const LuaTable& engines) -> RetCode {
        ...
        .DefMember("Preprocess",
                   [](LuaOnnxRuntimeBuilder* lbuilder) -> RetCode {
                       return lbuilder->ptr->Preprocess();
                   })
        .DefMember("CreateRuntime",
                   [runtime_class, lstate](LuaOnnxRuntimeBuilder* lbuilder) -> LuaObject {
