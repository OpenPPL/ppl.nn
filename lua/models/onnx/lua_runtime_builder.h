...
#ifndef _ST_HPC_PPL_NN_LUA_ONNX_LUA_RUNTIME_BUILDER_H_
#define _ST_HPC_PPL_NN_LUA_ONNX_LUA_RUNTIME_BUILDER_H_
...
struct LuaRuntimeBuilder final {
    LuaRuntimeBuilder(ppl::nn::onnx::RuntimeBuilder* b) : ptr(b) {}
    ~LuaRuntimeBuilder() {
        ptr.reset();
        engines.clear();
    }
