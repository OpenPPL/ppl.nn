...
#ifndef _ST_HPC_PPL_NN_LUA_PMX_LUA_RUNTIME_BUILDER_H_
#define _ST_HPC_PPL_NN_LUA_PMX_LUA_RUNTIME_BUILDER_H_
...
struct LuaRuntimeBuilder final {
    LuaRuntimeBuilder(ppl::nn::pmx::RuntimeBuilder* b) : ptr(b) {}
    ~LuaRuntimeBuilder() {
        ptr.reset();
        engines.clear();
    }
